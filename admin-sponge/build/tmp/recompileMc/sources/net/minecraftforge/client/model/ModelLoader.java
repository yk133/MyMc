...
public final class ModelLoader extends ModelBakery
{
    ...
    public IRegistry<ModelResourceLocation, IBakedModel> setupModelRegistry()
    {
        ...
        textureMap.func_174943_a(resourceManager, map -> textures.forEach(map::func_174942_a));
        ...
        {
            bakedRegistry.put(e.getKey(), bakedModels.get(e.getValue()));
        }
        return bakedRegistry;
    }
    ...
    private final class VanillaModelWrapper implements IModel
    {
        ...
        public Collection<ResourceLocation> getDependencies()
        {
            ...
            if(model.func_178305_e() != null && !model.func_178305_e().getPath().startsWith("builtin/"))
            {
        ...
        public Collection<ResourceLocation> getTextures()
        {
            ...
            {
                if(model.func_178305_e().getPath().equals("builtin/generated"))
                {
                    model.parent = MODEL_GENERATED;
                }
                else
                {
                    IModel parent = ModelLoaderRegistry.getModelOrLogError(model.func_178305_e(), "Could not load vanilla model parent '" + model.func_178305_e() + "' for '" + model);
        ...
        public VanillaModelWrapper smoothLighting(boolean value)
        {
            ...
            ModelBlock newModel = new ModelBlock(model.func_178305_e(), model.getElements(), model.textures, value, model.isGui3d(), model.getAllTransforms(), Lists.newArrayList(model.getOverrides()));
        ...
        public VanillaModelWrapper gui3d(boolean value)
        {
            ...
            ModelBlock newModel = new ModelBlock(model.func_178305_e(), model.getElements(), model.textures, model.ambientOcclusion, value, model.getAllTransforms(), Lists.newArrayList(model.getOverrides()));
            newModel.parent = model.parent;
            newModel.name = model.name;
            return new VanillaModelWrapper(location, newModel, uvlock, animation);
        }
    ...
    public static final class White extends TextureAtlasSprite
    {
        ...
        public boolean load(IResourceManager manager, ResourceLocation location, Function<ResourceLocation, TextureAtlasSprite> textureGetter)
        {
            ...
            int[][] pixels = new int[Minecraft.getInstance().gameSettings.mipmapLevels + 1][];
    ...
    public void onPostBakeEvent(IRegistry<ModelResourceLocation, IBakedModel> modelRegistry)
    {
        ...
        if(enableVerboseMissingInfo)
        {
            ...
            for(Map.Entry<IBlockState, ModelResourceLocation> entry : field_177610_k.func_178120_a().func_178446_a().entrySet())
            {
    ...
    protected static enum VariantLoader implements ICustomModelLoader
    {
        ...
        public IModel loadModel(ResourceLocation modelLocation) throws Exception
        {
            ...
            try
            {
                VariantList variants = definition.func_188004_c(variant.getVariant());
    ...
    private static class MultipartModel implements IModel
    {
        ...
        public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter)
        {
            ...
            for (Selector selector : multipart.getSelectors())
            {
                builder.putModel(selector.getPredicate(multipart.func_188135_c()), partModels.get(selector).bake(partModels.get(selector).getDefaultState(), format, bakedTextureGetter));
            }

            IBakedModel bakedModel = builder.build();
            return bakedModel;
        }
