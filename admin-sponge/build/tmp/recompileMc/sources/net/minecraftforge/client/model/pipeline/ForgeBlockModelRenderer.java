...
public class ForgeBlockModelRenderer extends BlockModelRenderer
{
    ...
    @Override
    public boolean func_187497_c(IBlockAccess world, IBakedModel model, IBlockState state, BlockPos pos, BufferBuilder buffer, boolean checkSides, long rand)
    {
    ...
    @Override
    public boolean func_187498_b(IBlockAccess world, IBakedModel model, IBlockState state, BlockPos pos, BufferBuilder buffer, boolean checkSides, long rand)
    {
        if(ForgeModContainer.forgeLightPipelineEnabled)
        {
