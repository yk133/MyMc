...
public class ClientCommandHandler extends CommandHandler
{
    ...
    public int func_71556_a(ICommandSender sender, String message)
    {
        ...
        {
            sender.sendMessage(format(RED, "commands.generic.usage", format(RED, wue.getMessage(), wue.func_74844_a())));
        }
        catch (CommandException ce)
        {
            sender.sendMessage(format(RED, ce.getMessage(), ce.func_74844_a()));
        }
        catch (Throwable t)
        {
    ...
    public void autoComplete(String leftOfCursor)
    {
        ...
        if (leftOfCursor.charAt(0) == '/')
        {
            ...
            {
                List<String> commands = func_180524_a(mc.player, leftOfCursor, mc.player.getPosition());
                if (!commands.isEmpty())
                {
