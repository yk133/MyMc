...
public class CommandTreeHelp extends CommandTreeBase
{
    ...
    public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        if (args.length == 0)
        {
            sender.sendMessage(TextComponentHelper.createComponentTranslation(sender, parent.func_71518_a(sender)));
    ...
    public static class HelpSubCommand extends CommandBase
    {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
        {
            sender.sendMessage(TextComponentHelper.createComponentTranslation(sender, command.func_71518_a(sender)));
        }
    }
}