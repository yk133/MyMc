...
public class BlockLiquidWrapper implements IFluidHandler
{
    ...
    public int fill(FluidStack resource, boolean doFill)
    {
        ...
        if (doFill)
        {
            ...
            world.setBlockState(blockPos, block.getDefaultState().func_177226_a(BlockLiquid.LEVEL, 0), 11);
        }
    ...
    public FluidStack drain(FluidStack resource, boolean doDrain)
    {
        ...
        IBlockState blockState = world.getBlockState(blockPos);
        if (blockState.getBlock() == blockLiquid && blockState.get(BlockLiquid.LEVEL) == 0)
        {
    ...
    private FluidStack getStack(IBlockState blockState)
    {
        ...
        if (material == Material.WATER && blockState.get(BlockLiquid.LEVEL) == 0)
        {
            return new FluidStack(FluidRegistry.WATER, Fluid.BUCKET_VOLUME);
        }
        else if (material == Material.LAVA && blockState.get(BlockLiquid.LEVEL) == 0)
        {
