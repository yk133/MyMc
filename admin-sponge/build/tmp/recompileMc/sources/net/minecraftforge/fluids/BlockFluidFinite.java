...
public class BlockFluidFinite extends BlockFluidBase
{
    ...
    public void func_180650_b(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull IBlockState state, @Nonnull Random rand)
    {
        ...
        int quantaRemaining = state.get(LEVEL) + 1;
        ...
        else if (quantaRemaining != prevRemaining)
        {
            ...
            if (quantaRemaining == 1)
            {
                world.setBlockState(pos, state.func_177226_a(LEVEL, quantaRemaining - 1), 2);
                return;
            }
        }
        ...
        for (EnumFacing side : EnumFacing.Plane.HORIZONTAL)
        {
            ...
            if (quanta >= 0)
            {
                ...
                if (newQuanta != quanta)
                {
                    ...
                    {
                        world.setBlockState(off, getDefaultState().func_177226_a(LEVEL, newQuanta - 1), 2);
                    }
        ...
        world.setBlockState(pos, state.func_177226_a(LEVEL, each - 1), 2);
    }
    ...
    public int tryToFlowVerticallyInto(World world, BlockPos pos, int amtToInput)
    {
        ...
        if (amt >= 0)
        {
            ...
            {
                world.setBlockState(other, myState.func_177226_a(LEVEL, quantaPerBlock - 1), 3);
                world.func_175684_a(other, this, tickRate);
                return amt - quantaPerBlock;
            }
            else if (amt > 0)
            {
                world.setBlockState(other, myState.func_177226_a(LEVEL, amt - 1), 3);
                world.func_175684_a(other, this, tickRate);
                world.removeBlock(pos);
                return 0;
            }
        ...
        else
        {
            ...
            if (density_other == Integer.MAX_VALUE)
            {
                ...
                {
                    world.setBlockState(other, myState.func_177226_a(LEVEL, amtToInput - 1), 3);
                    world.func_175684_a(other, this, tickRate);
                    world.removeBlock(pos);
                    return 0;
                }
            ...
            if (densityDir < 0)
            {
                if (density_other < density) // then swap
                {
                    ...
                    world.func_175684_a(other, this, tickRate);
                    world.func_175684_a(pos,   state.getBlock(), state.getBlock().tickRate(world));
                    return 0;
                }
            }
            else
    ...
    public int place(World world, BlockPos pos, @Nonnull FluidStack fluidStack, boolean doPlace)
    {
        ...
        {
            int existingQuanta = existing.get(LEVEL) + 1;
        ...
        if (doPlace)
        {
            ...
            world.setBlockState(pos, getDefaultState().func_177226_a(LEVEL, quanta - 1), 11);
        }
