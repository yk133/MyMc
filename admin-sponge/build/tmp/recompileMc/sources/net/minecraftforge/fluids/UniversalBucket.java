...
public class UniversalBucket extends Item
{
    ...
    public UniversalBucket(int capacity, @Nonnull ItemStack empty, boolean nbtSensitive)
    {
        ...
        BlockDispenser.DISPENSE_BEHAVIOR_REGISTRY.put(this, DispenseFluidContainer.getInstance());
    }
     ...
     */
    @Override
    public void fillItemGroup(@Nullable CreativeTabs tab, @Nonnull NonNullList<ItemStack> subItems)
    {
