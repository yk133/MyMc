...
public class BlockFluidClassic extends BlockFluidBase
{
    ...
    public void func_180650_b(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull IBlockState state, @Nonnull Random rand)
    {
        ...
        if (quantaRemaining < quantaPerBlock)
        {
            ...
            if (expQuanta != quantaRemaining)
            {
                ...
                {
                    world.setBlockState(pos, state.func_177226_a(LEVEL, quantaPerBlock - expQuanta), 2);
    ...
    {
        IBlockState state = world.getBlockState(pos);
        return state.getBlock() == this && state.get(LEVEL) == 0;
    }
    ...
    protected void flowIntoBlock(World world, BlockPos pos, int meta)
    {
        ...
        {
            world.setBlockState(pos, this.getDefaultState().func_177226_a(LEVEL, meta), 3);
        }
    }
