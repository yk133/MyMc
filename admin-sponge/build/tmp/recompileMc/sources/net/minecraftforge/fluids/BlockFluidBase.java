...
public abstract class BlockFluidBase extends Block implements IFluidBlock
{
    ...
    static
    {
        ...
        defaultDisplacements.put(Blocks.NETHER_PORTAL,                         false);
    ...
    public BlockFluidBase(Fluid fluid, Material material)
    {
        ...
        this.setDefaultState(stateContainer.getBaseState().func_177226_a(LEVEL, getMaxRenderHeightMeta()));
    }
    ...
    {
        return this.getDefaultState().func_177226_a(LEVEL, meta);
    }
    ...
    public float getFluidHeightForRender(IBlockAccess world, BlockPos pos, @Nonnull IBlockState up)
    {
        ...
        {
            return Math.min(1 - BlockLiquid.func_149801_b(here.get(BlockLiquid.LEVEL)), quantaFraction);
        }
