...
public class ForgeHooks
{
    ...
    static void initTools()
    {
        ...
        Block[] oreBlocks = new Block[] {
                ...
                Blocks.GOLD_ORE, Blocks.GOLD_BLOCK, Blocks.REDSTONE_ORE, Blocks.field_150439_ay
        };
    ...
    public static int onBlockBreakEvent(World world, GameType gameType, EntityPlayerMP entityPlayer, BlockPos pos)
    {
        ...
        if (gameType.hasLimitedInteractions())
        {
            ...
            {
                if (itemstack.isEmpty() || !itemstack.func_179544_c(world.getBlockState(pos).getBlock()))
                    preCancelEvent = true;
            }
        }
    ...
    public static EnumActionResult onPlaceItemIntoWorld(@Nonnull ItemStack itemstack, @Nonnull EntityPlayer player, @Nonnull World world, @Nonnull BlockPos pos, @Nonnull EnumFacing side, float hitX, float hitY, float hitZ, @Nonnull EnumHand hand)
    {
        ...
        EnumActionResult ret = itemstack.getItem().func_180614_a(player, world, pos, hand, side, hitX, hitY, hitZ);
        world.captureBlockSnapshots = false;

        if (ret == EnumActionResult.SUCCESS)
        {
            // save new item data
            int newMeta = itemstack.getDamage();
            ...
            else
            {
                ...
                for (BlockSnapshot snap : blockSnapshots)
                {
                    ...
                    {
                        newBlock.getBlock().func_176213_c(world, snap.getPos(), newBlock);
                    }

                    world.markAndNotifyBlock(snap.getPos(), null, oldBlock, newBlock, updateFlag);
                }
                player.addStat(StatList.func_188057_b(itemstack.getItem()));
            }
        }
        world.capturedBlockSnapshots.clear();
    ...
    {
        NoteBlockEvent.Change e = new NoteBlockEvent.Change(te.getWorld(), te.getPos(), te.getWorld().getBlockState(te.getPos()), old, te.field_145879_a);
    ...
    public static ItemStack getContainerItem(@Nonnull ItemStack stack)
    {
        if (stack.getItem().hasContainerItem(stack))
        {
            ...
            if (!stack.isEmpty() && stack.isDamageable() && stack.func_77960_j() > stack.getMaxDamage())
            {
