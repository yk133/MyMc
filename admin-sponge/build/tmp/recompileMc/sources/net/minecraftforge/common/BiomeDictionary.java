...
public class BiomeDictionary
{
    ...
    public static void makeBestGuess(Biome biome)
    {
        ...
        else if (biome.getScale() <= 0.3F && biome.getScale() >= 0.0F)
        {
        ...
        if (biome.field_76752_A.getBlock() != Blocks.SAND && biome.getDefaultTemperature() >= 1.0f && biome.getDownfall() < 0.2f)
        {
            BiomeDictionary.addTypes(biome, SAVANNA);
        }

        if (biome.field_76752_A.getBlock() == Blocks.SAND)
        {
            BiomeDictionary.addTypes(biome, SANDY);
        }
        else if (biome.field_76752_A.getBlock() == Blocks.MYCELIUM)
        {
            BiomeDictionary.addTypes(biome, MUSHROOM);
        }
        if (biome.field_76753_B.getBlock() == Blocks.TERRACOTTA)
        {
