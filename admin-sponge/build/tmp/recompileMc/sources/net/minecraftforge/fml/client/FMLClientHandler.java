...
public class FMLClientHandler implements IFMLSidedHandler
{
    ...
    public void finishMinecraftLoading()
    {
        ...
        RenderingRegistry.loadEntityRenderers(Minecraft.getInstance().getRenderManager().entityRenderMap);
    ...
    public boolean handleLoadingScreen(ScaledResolution scaledResolution) throws IOException
    {
        if (client.currentScreen instanceof GuiNotification)
        {
            ...
            client.currentScreen.render(mouseX, mouseZ, 0);
            client.currentScreen.func_146269_k();
...
//        showGuiScreen(new GuiModsMissingForServer(modMissingPacket));
    ...
    public void tryLoadExistingWorld(GuiWorldSelection selectWorldGUI, WorldSummary comparator)
    {
        ...
        NBTTagCompound fmlData = leveldat.getCompound("FML");
        if (fmlData.contains("ModItemData"))
        {
    ...
    public void logMissingTextureErrors()
    {
        ...
        Map<String,FallbackResourceManager> resManagers = ObfuscationReflectionHelper.getPrivateValue(SimpleReloadableResourceManager.class, (SimpleReloadableResourceManager)Minecraft.getInstance().func_110442_L(), "domainResourceManagers", "field_110548"+"_a");
    ...
    {
        this.client.creativeSettings.func_192562_a();
    }
    ...
    {
        IRenderHandler renderer = this.client.world.dimension.getCloudRenderer();
        if (renderer != null)
        {
