...
public class GuiOldSaveLoadConfirm extends GuiYesNo implements GuiYesNoCallback {
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (k = 0; k < this.buttons.size(); ++k)
        {
            this.buttons.get(k).func_191745_a(this.mc, mouseX, mouseY, partialTicks);
        }

        for (k = 0; k < this.labels.size(); ++k)
        {
            this.labels.get(k).func_146159_a(this.mc, mouseX, mouseY);
        }
    }
    @Override
