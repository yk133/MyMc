...
public class GuiModList extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttons.add(new GuiButton(6, ((modList.right + this.width) / 2) - 100, this.height - 38, I18n.format("gui.done")));
        ...
        this.buttons.add(configModButton);
        this.buttons.add(disableModButton);
        ...
        buttons.add(normalSort);
        x += width + buttonMargin;
        buttons.add(new GuiButton(SortType.A_TO_Z.buttonID, x, y, width - buttonMargin, 20, "A-Z"));
        x += width + buttonMargin;
        buttons.add(new GuiButton(SortType.Z_TO_A.buttonID, x, y, width - buttonMargin, 20, "Z-A"));
    ...
    {
        this.fontRenderer.func_78276_b(line, offset, shifty, 0xd7edea);
        return shifty + 10;
    }
    ...
    private class Info extends GuiScrollingList
    {
        ...
        protected void drawHeader(int entryRight, int relativeY, Tessellator tess)
        {
            ...
            if (logoPath != null)
            {
                ...
                GuiModList.this.mc.textureManager.bindTexture(logoPath);
