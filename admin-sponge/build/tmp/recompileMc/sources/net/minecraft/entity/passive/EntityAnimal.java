...
public abstract class EntityAnimal extends EntityAgeable implements IAnimals
{
    ...
    public void livingTick()
    {
        ...
        if (this.inLove > 0)
        {
            ...
            if (this.inLove % 10 == 0)
            {
                ...
                this.world.func_175688_a(EnumParticleTypes.HEART, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 0.5D + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, d0, d1, d2);
            }
        }
    }
    ...
    {
        return this.world.getBlockState(pos.down()).getBlock() == this.spawnableBlock ? 10.0F : this.world.func_175724_o(pos) - 0.5F;
    }
    ...
    public boolean getCanSpawnHere()
    {
        ...
        return this.world.getBlockState(blockpos.down()).getBlock() == this.spawnableBlock && this.world.func_175699_k(blockpos) > 8 && super.getCanSpawnHere();
    }
