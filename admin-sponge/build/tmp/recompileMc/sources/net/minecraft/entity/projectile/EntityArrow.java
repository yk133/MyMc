...
public abstract class EntityArrow extends Entity implements IProjectile
{
    ...
    public void tick()
    {
        ...
        else
        {
            ...
            if (this.getIsCritical())
            {
                for (int k = 0; k < 4; ++k)
                {
                    this.world.func_175688_a(EnumParticleTypes.CRIT, this.posX + this.motionX * (double)k / 4.0D, this.posY + this.motionY * (double)k / 4.0D, this.posZ + this.motionZ * (double)k / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
                }
            }
    ...
    public void writeAdditional(NBTTagCompound compound)
    {
        ...
        ResourceLocation resourcelocation = Block.REGISTRY.getKey(this.field_145790_g);
        compound.putString("inTile", resourcelocation == null ? "" : resourcelocation.toString());
        compound.putByte("inData", (byte)this.field_70253_h);
    ...
    public void readAdditional(NBTTagCompound compound)
    {
        ...
        {
            this.field_145790_g = Block.getBlockFromName(compound.getString("inTile"));
        }
        else
        {
