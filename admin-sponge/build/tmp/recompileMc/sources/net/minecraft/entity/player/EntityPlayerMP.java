...
public class EntityPlayerMP extends EntityPlayer implements IContainerListener
{
    ...
    public EntityPlayerMP(MinecraftServer server, WorldServer worldIn, GameProfile profile, PlayerInteractionManager interactionManagerIn)
    {
        ...
        BlockPos blockpos = worldIn.dimension.getRandomizedSpawnPoint();

        if (false && worldIn.dimension.hasSkyLight() && worldIn.getWorldInfo().getGameType() != GameType.ADVENTURE)
        {
    ...
    public void writeAdditional(NBTTagCompound compound)
    {
        ...
        if (this.enteredNetherPosition != null)
        {
            ...
            compound.put("enteredNetherPosition", nbttagcompound);
        }
        ...
        if (entity != null && entity1 != this && entity1.func_184180_b(EntityPlayerMP.class).size() == 1)
        {
            ...
            compound.put("RootVehicle", nbttagcompound1);
        }
    ...
    public void copyFrom(EntityPlayerMP that, boolean keepEverything)
    {
        ...
        {
            getEntityData().put(PERSISTED_NBT_TAG, old.getCompound(PERSISTED_NBT_TAG));
        }
