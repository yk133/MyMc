...
public class EntityEnderman extends EntityMob
{
    ...
    public void writeAdditional(NBTTagCompound compound)
    {
        ...
        if (iblockstate != null)
        {
            compound.putShort("carried", (short)Block.func_149682_b(iblockstate.getBlock()));
            compound.putShort("carriedData", (short)iblockstate.getBlock().func_176201_c(iblockstate));
        }
    }
    ...
    public void readAdditional(NBTTagCompound compound)
    {
        ...
        {
            iblockstate = Block.getBlockFromName(compound.getString("carried")).func_176203_a(compound.getShort("carriedData") & 65535);
        }
        else
        {
            iblockstate = Block.getBlockById(compound.getShort("carried")).func_176203_a(compound.getShort("carriedData") & 65535);
        }
    ...
    public void livingTick()
    {
        if (this.world.isRemote)
        {
            for (int i = 0; i < 2; ++i)
            {
                this.world.func_175688_a(EnumParticleTypes.PORTAL, this.posX + (this.rand.nextDouble() - 0.5D) * (double)this.width, this.posY + this.rand.nextDouble() * (double)this.height - 0.25D, this.posZ + (this.rand.nextDouble() - 0.5D) * (double)this.width, (this.rand.nextDouble() - 0.5D) * 2.0D, -this.rand.nextDouble(), (this.rand.nextDouble() - 0.5D) * 2.0D);
            }
        }
    ...
    static class AIFindPlayer extends EntityAINearestAttackableTarget<EntityPlayer>
        {
            ...
            public boolean shouldContinueExecuting()
            {
                ...
                {
                    return this.targetEntity != null && ((EntityPlayer)this.targetEntity).isAlive() ? true : super.shouldContinueExecuting();
                }
            }
