...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant
{
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand)
    {
        ...
        else if (!this.func_190669_a(itemstack, this.getClass()) && this.isAlive() && !this.isTrading() && !this.isChild() && !player.isSneaking())
        {
    ...
    public void writeAdditional(NBTTagCompound compound)
    {
        ...
        compound.putString("ProfessionName", this.getProfessionForge().getRegistryName().toString());
        ...
        if (this.buyingList != null)
        {
            compound.put("Offers", this.buyingList.write());
        }
    ...
    public void readAdditional(NBTTagCompound compound)
    {
        ...
        if (compound.contains("ProfessionName"))
        {
    ...
    private void func_180489_a(EnumParticleTypes p_180489_1_)
    {
        for (int i = 0; i < 5; ++i)
        {
            ...
            this.world.func_175688_a(p_180489_1_, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 1.0D + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, d0, d1, d2);
        }
    }
    ...
    {
        return this.finalizeMobSpawn(p_180482_1_, p_180482_2_, true);
    }
    ...
    public static class ItemAndEmeraldToItem implements EntityVillager.ITradeList
        {
            ...
            public void addMerchantRecipe(IMerchant merchant, MerchantRecipeList recipeList, Random random)
            {
                ...
                recipeList.add(new MerchantRecipe(new ItemStack(this.field_179411_a.getItem(), i, this.field_179411_a.func_77960_j()), new ItemStack(Items.EMERALD), new ItemStack(this.field_179410_c.getItem(), j, this.field_179410_c.func_77960_j())));
            }
        }
    ...
    public static class ListEnchantedItemForEmeralds implements EntityVillager.ITradeList
        {
            ...
            public void addMerchantRecipe(IMerchant merchant, MerchantRecipeList recipeList, Random random)
            {
                ...
                ItemStack itemstack1 = EnchantmentHelper.addRandomEnchantment(random, new ItemStack(this.enchantedItemStack.getItem(), 1, this.enchantedItemStack.func_77960_j()), 5 + random.nextInt(15), false);
    ...
    public static class ListItemForEmeralds implements EntityVillager.ITradeList
        {
            ...
            public void addMerchantRecipe(IMerchant merchant, MerchantRecipeList recipeList, Random random)
            {
                ...
                if (i < 0)
                {
                    ...
                    itemstack1 = new ItemStack(this.itemToBuy.getItem(), -i, this.itemToBuy.func_77960_j());
                }
                else
                {
    ...
    static class TreasureMapForEmeralds implements EntityVillager.ITradeList
        {
            ...
            public void addMerchantRecipe(IMerchant merchant, MerchantRecipeList recipeList, Random random)
            {
                ...
                BlockPos blockpos = world.func_190528_a(this.destination, merchant.getPos(), true);
