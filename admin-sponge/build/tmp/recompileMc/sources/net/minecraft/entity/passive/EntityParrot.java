...
public class EntityParrot extends EntityShoulderRiding implements EntityFlying
{
    ...
    public boolean getCanSpawnHere()
    {
        ...
        return block instanceof BlockLeaves || block == Blocks.GRASS || block instanceof BlockLog || block == Blocks.AIR && this.world.func_175699_k(blockpos) > 8 && super.getCanSpawnHere();
    }
    ...
    static
    {
        registerMimicSound(EntityBlaze.class,           SoundEvents.ENTITY_PARROT_IMITATE_BLAZE);
        registerMimicSound(EntityCaveSpider.class,      SoundEvents.ENTITY_PARROT_IMITATE_SPIDER);
        registerMimicSound(EntityCreeper.class,         SoundEvents.ENTITY_PARROT_IMITATE_CREEPER);
        registerMimicSound(EntityElderGuardian.class,   SoundEvents.ENTITY_PARROT_IMITATE_ELDER_GUARDIAN);
        registerMimicSound(EntityDragon.class,          SoundEvents.ENTITY_PARROT_IMITATE_ENDER_DRAGON);
        registerMimicSound(EntityEnderman.class,        SoundEvents.ENTITY_PARROT_IMITATE_ENDERMAN);
        registerMimicSound(EntityEndermite.class,       SoundEvents.ENTITY_PARROT_IMITATE_ENDERMITE);
        registerMimicSound(EntityEvoker.class,          SoundEvents.ENTITY_PARROT_IMITATE_EVOKER);
        registerMimicSound(EntityGhast.class,           SoundEvents.ENTITY_PARROT_IMITATE_GHAST);
        registerMimicSound(EntityHusk.class,            SoundEvents.ENTITY_PARROT_IMITATE_HUSK);
        registerMimicSound(EntityIllusionIllager.class, SoundEvents.ENTITY_PARROT_IMITATE_ILLUSIONER);
        registerMimicSound(EntityMagmaCube.class,       SoundEvents.ENTITY_PARROT_IMITATE_MAGMA_CUBE);
        registerMimicSound(EntityPigZombie.class,       SoundEvents.ENTITY_PARROT_IMITATE_ZOMBIE_PIGMAN);
        registerMimicSound(EntityPolarBear.class,       SoundEvents.ENTITY_PARROT_IMITATE_POLAR_BEAR);
        registerMimicSound(EntityShulker.class,         SoundEvents.ENTITY_PARROT_IMITATE_SHULKER);
        registerMimicSound(EntitySilverfish.class,      SoundEvents.ENTITY_PARROT_IMITATE_SILVERFISH);
        registerMimicSound(EntitySkeleton.class,        SoundEvents.ENTITY_PARROT_IMITATE_SKELETON);
        registerMimicSound(EntitySlime.class,           SoundEvents.ENTITY_PARROT_IMITATE_SLIME);
        registerMimicSound(EntitySpider.class,          SoundEvents.ENTITY_PARROT_IMITATE_SPIDER);
        registerMimicSound(EntityStray.class,           SoundEvents.ENTITY_PARROT_IMITATE_STRAY);
        registerMimicSound(EntityVex.class,             SoundEvents.ENTITY_PARROT_IMITATE_VEX);
        registerMimicSound(EntityVindicator.class,      SoundEvents.ENTITY_PARROT_IMITATE_VINDICATOR);
        registerMimicSound(EntityWitch.class,           SoundEvents.ENTITY_PARROT_IMITATE_WITCH);
        registerMimicSound(EntityWither.class,          SoundEvents.ENTITY_PARROT_IMITATE_WITHER);
        registerMimicSound(EntityWitherSkeleton.class,  SoundEvents.ENTITY_PARROT_IMITATE_WITHER_SKELETON);
        registerMimicSound(EntityWolf.class,            SoundEvents.ENTITY_PARROT_IMITATE_WOLF);
        registerMimicSound(EntityZombie.class,          SoundEvents.ENTITY_PARROT_IMITATE_ZOMBIE);
        registerMimicSound(EntityZombieVillager.class,  SoundEvents.ENTITY_PARROT_IMITATE_ZOMBIE_VILLAGER);
    }
