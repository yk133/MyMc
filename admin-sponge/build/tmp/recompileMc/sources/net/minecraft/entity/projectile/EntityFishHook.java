    ...
    private void catchingFish(BlockPos p_190621_1_)
    {
        ...
        else if (this.ticksCatchableDelay > 0)
        {
            ...
            else
            {
                ...
                worldserver.func_175739_a(EnumParticleTypes.WATER_BUBBLE, this.posX, d3, this.posZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0D, (double)this.width, 0.20000000298023224D);
                worldserver.func_175739_a(EnumParticleTypes.WATER_WAKE, this.posX, d3, this.posZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0D, (double)this.width, 0.20000000298023224D);
    ...
    public int handleHookRetraction()
    {
        if (!this.world.isRemote && this.angler != null)
        {
            ...
            else if (this.ticksCatchable > 0)
            {
                ...
                List<ItemStack> result = this.world.func_184146_ak().getLootTableFromLocation(LootTableList.GAMEPLAY_FISHING).generateLootForPools(this.rand, lootcontext$builder.build());
