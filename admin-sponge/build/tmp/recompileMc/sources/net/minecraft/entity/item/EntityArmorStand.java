...
public class EntityArmorStand extends EntityLivingBase
{
    ...
    private void playParticles()
    {
        ...
        {
            ((WorldServer)this.world).func_175739_a(EnumParticleTypes.BLOCK_DUST, this.posX, this.posY + (double)this.height / 1.5D, this.posZ, 10, (double)(this.width / 4.0F), (double)(this.height / 4.0F), (double)(this.width / 4.0F), 0.05D, Block.func_176210_f(Blocks.field_150344_f.getDefaultState()));
        }
    }
