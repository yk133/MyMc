...
public class EntityBlaze extends EntityMob
{
    ...
    public void livingTick()
    {
        ...
        if (this.world.isRemote)
        {
            ...
            for (int i = 0; i < 2; ++i)
            {
                this.world.func_175688_a(EnumParticleTypes.SMOKE_LARGE, this.posX + (this.rand.nextDouble() - 0.5D) * (double)this.width, this.posY + this.rand.nextDouble() * (double)this.height, this.posZ + (this.rand.nextDouble() - 0.5D) * (double)this.width, 0.0D, 0.0D, 0.0D);
            }
        }
