...
public class EntityTrackerEntry
{
    ...
    public void tick(List<EntityPlayer> players)
    {
        ...
        if (this.trackedEntity instanceof EntityItemFrame && this.updateCounter % 10 == 0)
        {
            ...
            {
                MapData mapdata = ((ItemMap) itemstack.getItem()).func_77873_a(itemstack, this.trackedEntity.world);
    ...
    private Packet<?> createSpawnPacket()
    {
        ...
        else if (this.trackedEntity instanceof EntityFallingBlock)
        {
            ...
            return new SPacketSpawnObject(this.trackedEntity, 70, Block.func_176210_f(entityfallingblock.func_175131_l()));
        }
