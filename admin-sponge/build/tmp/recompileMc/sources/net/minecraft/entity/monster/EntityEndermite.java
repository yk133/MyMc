...
public class EntityEndermite extends EntityMob
{
    ...
    public void livingTick()
    {
        ...
        if (this.world.isRemote)
        {
            for (int i = 0; i < 2; ++i)
            {
                this.world.func_175688_a(EnumParticleTypes.PORTAL, this.posX + (this.rand.nextDouble() - 0.5D) * (double)this.width, this.posY + this.rand.nextDouble() * (double)this.height, this.posZ + (this.rand.nextDouble() - 0.5D) * (double)this.width, (this.rand.nextDouble() - 0.5D) * 2.0D, -this.rand.nextDouble(), (this.rand.nextDouble() - 0.5D) * 2.0D);
            }
        }
        else
        {
