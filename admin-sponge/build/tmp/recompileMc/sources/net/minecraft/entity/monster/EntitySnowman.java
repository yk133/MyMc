    ...
    public void livingTick()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            for (int l = 0; l < 4; ++l)
            {
                ...
                if (this.world.getBlockState(blockpos).getMaterial() == Material.AIR && this.world.getBiome(blockpos).getTemperature(blockpos) < 0.8F && Blocks.field_150431_aC.func_176196_c(this.world, blockpos))
                {
