...
public class EntityLightningBolt extends EntityWeatherEffect
{
    ...
    public EntityLightningBolt(World worldIn, double x, double y, double z, boolean effectOnlyIn)
    {
        ...
        if (!effectOnlyIn && !worldIn.isRemote && worldIn.getGameRules().getBoolean("doFireTick") && (worldIn.getDifficulty() == EnumDifficulty.NORMAL || worldIn.getDifficulty() == EnumDifficulty.HARD) && worldIn.func_175697_a(blockpos, 10))
        {
        ...
        if (this.lightningState < 0)
        {
            ...
            else if (this.lightningState < -this.rand.nextInt(10))
            {
                ...
                if (!this.effectOnly && !this.world.isRemote)
                {
                    ...
                    if (this.world.getGameRules().getBoolean("doFireTick") && this.world.func_175697_a(blockpos, 10) && this.world.getBlockState(blockpos).getMaterial() == Material.AIR && Blocks.FIRE.func_176196_c(this.world, blockpos))
                    {
