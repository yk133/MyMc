    ...
    protected boolean tryTeleportToNewPosition()
    {
        if (!this.isAIDisabled() && this.isAlive())
        {
            ...
            for (int i = 0; i < 5; ++i)
            {
                ...
                if (blockpos1.getY() > 0 && this.world.isAirBlock(blockpos1) && this.world.isInsideWorldBorder(this) && this.world.func_184144_a(this, new AxisAlignedBB(blockpos1)).isEmpty())
                {
                    boolean flag = false;
