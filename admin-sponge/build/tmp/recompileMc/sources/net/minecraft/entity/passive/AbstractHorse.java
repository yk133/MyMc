...
public abstract class AbstractHorse extends EntityAnimal implements IInventoryChangedListener, IJumpingMount
{
    ...
    protected boolean handleEating(EntityPlayer player, ItemStack stack)
    {
        ...
        if (this.isChild() && i > 0)
        {
            this.world.func_175688_a(EnumParticleTypes.VILLAGER_HAPPY, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 0.5D + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, 0.0D, 0.0D, 0.0D);
    ...
    public void writeAdditional(NBTTagCompound compound)
    {
        ...
        {
            compound.put("SaddleItem", this.horseChest.getStackInSlot(0).write(new NBTTagCompound()));
        }
    }
    ...
    protected void spawnHorseParticles(boolean p_110216_1_)
    {
        ...
        for (int i = 0; i < 7; ++i)
        {
            ...
            this.world.func_175688_a(enumparticletypes, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 0.5D + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, d0, d1, d2);
        }
    }
