...
public class EntityShulkerBullet extends Entity
{
    ...
    protected void writeAdditional(NBTTagCompound compound)
    {
        ...
        if (this.target != null)
        {
            ...
            compound.put("Target", nbttagcompound1);
        }
    ...
    public void tick()
    {
        ...
        else
        {
            ...
            if (this.world.isRemote)
            {
                this.world.func_175688_a(EnumParticleTypes.END_ROD, this.posX - this.motionX, this.posY - this.motionY + 0.15D, this.posZ - this.motionZ, 0.0D, 0.0D, 0.0D);
            }
    ...
    protected void bulletHit(RayTraceResult result)
    {
        ...
        else
        {
            ...
            if (flag)
            {
                ...
                {
                    ((EntityLivingBase)result.entity).func_70690_d(new PotionEffect(MobEffects.LEVITATION, 200));
                }
            }
        }
