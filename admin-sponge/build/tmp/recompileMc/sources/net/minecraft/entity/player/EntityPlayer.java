...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public static void func_189806_a(DataFixer p_189806_0_)
    {
        p_189806_0_.func_188258_a(FixTypes.PLAYER, new IDataWalker()
        {
            public NBTTagCompound func_188266_a(IDataFixer p_188266_1_, NBTTagCompound p_188266_2_, int p_188266_3_)
            {
                ...
                {
                    p_188266_2_.put("ShoulderEntityLeft", p_188266_1_.func_188251_a(FixTypes.ENTITY, p_188266_2_.getCompound("ShoulderEntityLeft"), p_188266_3_));
                }

                if (p_188266_2_.contains("ShoulderEntityRight", 10))
                {
                    p_188266_2_.put("ShoulderEntityRight", p_188266_1_.func_188251_a(FixTypes.ENTITY, p_188266_2_.getCompound("ShoulderEntityRight"), p_188266_3_));
                }
    ...
    public void readAdditional(NBTTagCompound compound)
    {
        ...
        spawnlist = compound.getList("Spawns", 10);
        for (int i = 0; i < spawnlist.func_74745_c(); i++)
        {
            NBTTagCompound spawndata = (NBTTagCompound)spawnlist.getCompound(i);
            int spawndim = spawndata.getInt("Dim");
            this.spawnChunkMap.put(spawndim, new BlockPos(spawndata.getInt("SpawnX"), spawndata.getInt("SpawnY"), spawndata.getInt("SpawnZ")));
            this.spawnForcedMap.put(spawndim, spawndata.getBoolean("SpawnForced"));
        }
        this.spawnDimension = compound.getBoolean("HasSpawnDimensionSet") ? compound.getInt("SpawnDimension") : null;
    ...
    public void writeAdditional(NBTTagCompound compound)
    {
        ...
        compound.put("Inventory", this.inventory.write(new NBTTagList()));
        ...
        for (java.util.Map.Entry<Integer, BlockPos> entry : this.spawnChunkMap.entrySet())
        {
            ...
            spawndata.putInt("Dim", entry.getKey());
            spawndata.putInt("SpawnX", spawn.getX());
            spawndata.putInt("SpawnY", spawn.getY());
            spawndata.putInt("SpawnZ", spawn.getZ());
            spawndata.putBoolean("SpawnForced", forced);
            spawnlist.func_74742_a(spawndata);
        }
        compound.put("Spawns", spawnlist);

        compound.putBoolean("HasSpawnDimensionSet", this.hasSpawnDimension());
        if (this.hasSpawnDimension())
            compound.putInt("SpawnDimension", this.getSpawnDimension());

        this.foodStats.write(compound);
        this.abilities.write(compound);
        compound.put("EnderItems", this.enderChest.write());
                    ...
                    if (flag5)
                    {
                        ...
                        if (targetEntity instanceof EntityLivingBase)
                        {
                            ...
                            if (this.world instanceof WorldServer && f5 > 2.0F)
                            {
                                ...
                                ((WorldServer)this.world).func_175739_a(EnumParticleTypes.DAMAGE_INDICATOR, targetEntity.posX, targetEntity.posY + (double)(targetEntity.height * 0.5F), targetEntity.posZ, k, 0.1D, 0.0D, 0.1D, 0.2D);
                            }
                        }
    ...
    public void spawnSweepParticles()
    {
        ...
        {
            ((WorldServer)this.world).func_175739_a(EnumParticleTypes.SWEEP_ATTACK, this.posX + d0, this.posY + (double)this.height * 0.5D, this.posZ + d1, 0, d0, 0.0D, d1, 0.0D);
        }
    }
    ...
    public ITextComponent getDisplayName()
    {
        ...
        itextcomponent.appendSibling(new TextComponentString(ScorePlayerTeam.func_96667_a(this.getTeam(), this.getDisplayNameString())));
    ...
    public boolean canOpen(LockCode code)
    {
        ...
        {
            ItemStack itemstack = this.getHeldItemMainhand();
            return !itemstack.isEmpty() && itemstack.hasDisplayName() ? itemstack.func_82833_r().equals(code.getLock()) : false;
        }
    }
    ...
    public <T> T getCapability(net.minecraftforge.common.capabilities.Capability<T> capability, @Nullable net.minecraft.util.EnumFacing facing)
    {
        if (capability == net.minecraftforge.items.CapabilityItemHandler.ITEM_HANDLER_CAPABILITY)
        {
            ...
            else if (facing.getAxis().func_176720_b()) return (T) playerMainHandler;
