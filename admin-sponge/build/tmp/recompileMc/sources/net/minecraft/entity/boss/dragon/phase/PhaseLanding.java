...
public class PhaseLanding extends PhaseBase
{
    ...
    public void clientTick()
    {
        ...
        for (int i = 0; i < 8; ++i)
        {
            ...
            this.dragon.world.func_175688_a(EnumParticleTypes.DRAGON_BREATH, d3, d4, d5, -vec3d.x * 0.07999999821186066D + this.dragon.motionX, -vec3d.y * 0.30000001192092896D + this.dragon.motionY, -vec3d.z * 0.07999999821186066D + this.dragon.motionZ);
