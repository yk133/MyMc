...
public class EntityTippedArrow extends EntityArrow
{
    ...
    private void spawnPotionParticles(int particleCount)
    {
        ...
        if (i != -1 && particleCount > 0)
        {
            ...
            {
                this.world.func_175688_a(EnumParticleTypes.SPELL_MOB, this.posX + (this.rand.nextDouble() - 0.5D) * (double)this.width, this.posY + this.rand.nextDouble() * (double)this.height, this.posZ + (this.rand.nextDouble() - 0.5D) * (double)this.width, d0, d1, d2);
            }
        }
    }
    ...
    public void writeAdditional(NBTTagCompound compound)
    {
        ...
        if (!this.customPotionEffects.isEmpty())
        {
            ...
            compound.put("CustomPotionEffects", nbttaglist);
        }
    }
