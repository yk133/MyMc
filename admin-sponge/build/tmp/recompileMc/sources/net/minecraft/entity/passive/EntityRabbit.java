...
public class EntityRabbit extends EntityAnimal
{
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(3, new EntityAITempt(this, 1.0D, Item.getItemFromBlock(Blocks.field_150327_N), false));
    ...
    protected void func_175528_cn()
    {
        ...
        this.world.func_175688_a(EnumParticleTypes.BLOCK_DUST, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 0.5D + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, 0.0D, 0.0D, 0.0D, Block.func_176210_f(iblockstate));
        this.carrotTicks = 40;
    }
                ...
                if (this.getIsAboveDestination())
                {
                    ...
                    if (this.canRaid && block instanceof BlockCarrot)
                    {
                        ...
                        else
                        {
                            ...
                            world.playEvent(2001, blockpos, Block.func_176210_f(iblockstate));
                        }
