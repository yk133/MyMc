    ...
    public boolean add(int p_191971_1_, final ItemStack p_191971_2_)
    {
        ...
        else
        {
            ...
            catch (Throwable throwable)
            {
                ...
                crashreportcategory.addDetail("Item ID", Integer.valueOf(Item.getIdFromItem(p_191971_2_.getItem())));
                crashreportcategory.addDetail("Item data", Integer.valueOf(p_191971_2_.func_77960_j()));
