...
{
    private static final Predicate<IBlockState> IS_TALL_GRASS = BlockStateMatcher.forBlock(Blocks.field_150329_H).func_177637_a(BlockTallGrass.field_176497_a, Predicates.equalTo(BlockTallGrass.EnumType.GRASS));
        ...
        if (this.eatingGrassTimer == 4)
        {
            ...
            else
            {
                ...
                if (this.entityWorld.getBlockState(blockpos1).getBlock() == Blocks.GRASS)
                {
                    if (net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.entityWorld, this.grassEaterEntity))
                    {
                        this.entityWorld.playEvent(2001, blockpos1, Block.func_149682_b(Blocks.GRASS));
