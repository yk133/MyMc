    ...
    public void livingTick()
    {
        ...
        if (this.world.isRemote && this.isInvisible())
        {
            ...
            else
            {
                ...
                for (int l = 0; l < 16; ++l)
                {
                    this.world.func_175688_a(EnumParticleTypes.CLOUD, this.posX + (this.rand.nextDouble() - 0.5D) * (double)this.width, this.posY + this.rand.nextDouble() * (double)this.height, this.posZ + (this.rand.nextDouble() - 0.5D) * (double)this.width, 0.0D, 0.0D, 0.0D);
                }
