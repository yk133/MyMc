                ...
                return new AbstractIterator<BlockPos>()
                {
                    ...
                    protected BlockPos computeNext()
                    {
                        if (this.field_191534_b)
                        {
                            ...
                            this.field_191535_c = x1;
                            this.field_191536_d = y1;
                            this.field_191537_e = z1;
                            return new BlockPos(x1, y1, z1);
                        }
                        else if (this.field_191535_c == x2 && this.field_191536_d == y2 && this.field_191537_e == z2)
                        {
                            return (BlockPos)this.endOfData();
                        }
                        else
                        {
                            if (this.field_191535_c < x2)
                            {
                                ++this.field_191535_c;
                            }
                            else if (this.field_191536_d < y2)
                            {
                                this.field_191535_c = x1;
                                ++this.field_191536_d;
                            }
                            else if (this.field_191537_e < z2)
                            {
                                this.field_191535_c = x1;
                                this.field_191536_d = y1;
                                ++this.field_191537_e;
