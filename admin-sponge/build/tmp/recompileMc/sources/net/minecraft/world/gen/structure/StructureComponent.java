...
public abstract class StructureComponent
{
     ...
     */
    protected abstract void writeAdditional(NBTTagCompound tagCompound);
    ...
    protected boolean generateChest(World p_191080_1_, StructureBoundingBox p_191080_2_, Random p_191080_3_, BlockPos p_191080_4_, ResourceLocation p_191080_5_, @Nullable IBlockState p_191080_6_)
    {
        if (p_191080_2_.isVecInside(p_191080_4_) && p_191080_1_.getBlockState(p_191080_4_).getBlock() != Blocks.CHEST)
        {
            if (p_191080_6_ == null)
            {
                p_191080_6_ = Blocks.CHEST.func_176458_f(p_191080_1_, p_191080_4_, Blocks.CHEST.getDefaultState());
            }
    ...
    {
        this.setBlockState(worldIn, door.getDefaultState().func_177226_a(BlockDoor.FACING, facing), x, y, z, sbb);
        this.setBlockState(worldIn, door.getDefaultState().func_177226_a(BlockDoor.FACING, facing).func_177226_a(BlockDoor.HALF, BlockDoor.EnumDoorHalf.UPPER), x, y + 1, z, sbb);
    }
