...
public class MapGenStructureIO
{
    ...
    public static StructureStart func_143035_a(NBTTagCompound p_143035_0_, World p_143035_1_)
    {
        ...
        try
        {
            Class <? extends StructureStart > oclass = (Class)startNameToClassMap.get(p_143035_0_.getString("id"));
        ...
        {
            structurestart.read(p_143035_1_, p_143035_0_);
        }
        else
        {
    ...
    public static StructureComponent getStructureComponent(NBTTagCompound tagCompound, World worldIn)
    {
        ...
        {
            structurecomponent.read(worldIn, tagCompound);
        }
        else
        {
