...
public class WorldType
{
    ...
    public net.minecraft.world.biome.BiomeProvider getBiomeProvider(World world)
    {
        if (this == FLAT)
        {
            net.minecraft.world.gen.FlatGeneratorInfo flatgeneratorinfo = net.minecraft.world.gen.FlatGeneratorInfo.createFlatGeneratorFromString(world.getWorldInfo().func_82571_y());
