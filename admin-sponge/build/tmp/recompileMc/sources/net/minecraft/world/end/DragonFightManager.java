...
public class DragonFightManager
{
    ...
    public NBTTagCompound write()
    {
        ...
        nbttagcompound.putBoolean("LegacyScanPerformed", !this.scanForLegacyFight); // Forge: fix MC-105080

        if (this.exitPortalLocation != null)
        {
            nbttagcompound.put("ExitPortalLocation", NBTUtil.writeBlockPos(this.exitPortalLocation));
        }
