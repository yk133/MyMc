...
public class BiomeMesa extends Biome
{
    ...
    public void func_180622_a(World p_180622_1_, Random p_180622_2_, ChunkPrimer p_180622_3_, int p_180622_4_, int p_180622_5_, double p_180622_6_)
    {
        ...
        if (this.field_150626_aH)
        {
            ...
            double d0 = Math.min(Math.abs(p_180622_6_), this.field_150623_aE.getValue((double)i * 0.25D, (double)j * 0.25D));

            if (d0 > 0.0D)
            {
                double d1 = 0.001953125D;
                double d2 = Math.abs(this.field_150624_aF.getValue((double)i * 0.001953125D, (double)j * 0.001953125D));
                d4 = d0 * d0 * 2.5D;
    ...
    {
        int i = (int)Math.round(this.field_150625_aG.getValue((double)p_180629_1_ / 512.0D, (double)p_180629_1_ / 512.0D) * 2.0D);
