    ...
    public static class ChestCorridor extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                else
                {
                    ...
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, 1, 2, 3, 1, 4, Blocks.field_150417_aV.getDefaultState(), Blocks.field_150417_aV.getDefaultState(), false);
                    this.setBlockState(worldIn, Blocks.STONE_SLAB.func_176203_a(BlockStoneSlab.EnumType.SMOOTHBRICK.func_176624_a()), 3, 1, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STONE_SLAB.func_176203_a(BlockStoneSlab.EnumType.SMOOTHBRICK.func_176624_a()), 3, 1, 5, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STONE_SLAB.func_176203_a(BlockStoneSlab.EnumType.SMOOTHBRICK.func_176624_a()), 3, 2, 2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STONE_SLAB.func_176203_a(BlockStoneSlab.EnumType.SMOOTHBRICK.func_176624_a()), 3, 2, 4, structureBoundingBoxIn);

                    for (int i = 2; i <= 4; ++i)
                    {
                        this.setBlockState(worldIn, Blocks.STONE_SLAB.func_176203_a(BlockStoneSlab.EnumType.SMOOTHBRICK.func_176624_a()), 2, 1, i, structureBoundingBoxIn);
                    }
    ...
    public static class Corridor extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                else
                {
                    ...
                    {
                        this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 0, 0, i, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 1, 0, i, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 2, 0, i, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 3, 0, i, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 4, 0, i, structureBoundingBoxIn);

                        for (int j = 1; j <= 3; ++j)
                        {
                            this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 0, j, i, structureBoundingBoxIn);
                            ...
                            this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 4, j, i, structureBoundingBoxIn);
                        }

                        this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 0, 4, i, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 1, 4, i, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 2, 4, i, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 3, 4, i, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 4, 4, i, structureBoundingBoxIn);
                    }
    ...
    public static class Crossing extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                else
                {
                    ...
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 5, 7, 7, 5, 9, Blocks.field_150334_T.getDefaultState(), Blocks.field_150334_T.getDefaultState(), false);
                    this.setBlockState(worldIn, Blocks.TORCH.getDefaultState().func_177226_a(BlockTorch.field_176596_a, EnumFacing.SOUTH), 6, 5, 6, structureBoundingBoxIn);
                    return true;
                }
            }
        }
    ...
    public static class Library extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                else
                {
                    ...
                    this.generateMaybeBox(worldIn, structureBoundingBoxIn, randomIn, 0.07F, 2, 1, 1, 11, 4, 13, Blocks.field_150321_G.getDefaultState(), Blocks.field_150321_G.getDefaultState(), false, 0);
                    int j = 1;
                    int k = 12;
                    ...
                    for (int l = 1; l <= 13; ++l)
                    {
                        if ((l - 1) % 4 == 0)
                        {
                            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 1, l, 1, 4, l, Blocks.field_150344_f.getDefaultState(), Blocks.field_150344_f.getDefaultState(), false);
                            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 12, 1, l, 12, 4, l, Blocks.field_150344_f.getDefaultState(), Blocks.field_150344_f.getDefaultState(), false);
                            this.setBlockState(worldIn, Blocks.TORCH.getDefaultState().func_177226_a(BlockTorch.field_176596_a, EnumFacing.EAST), 2, 3, l, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.TORCH.getDefaultState().func_177226_a(BlockTorch.field_176596_a, EnumFacing.WEST), 11, 3, l, structureBoundingBoxIn);

                            if (this.isLargeRoom)
                            {
                                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 6, l, 1, 9, l, Blocks.field_150344_f.getDefaultState(), Blocks.field_150344_f.getDefaultState(), false);
                                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 12, 6, l, 12, 9, l, Blocks.field_150344_f.getDefaultState(), Blocks.field_150344_f.getDefaultState(), false);
                            }
                        }
                        else
                        {
                    ...
                    if (this.isLargeRoom)
                    {
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 5, 1, 3, 5, 13, Blocks.field_150344_f.getDefaultState(), Blocks.field_150344_f.getDefaultState(), false);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 10, 5, 1, 12, 5, 13, Blocks.field_150344_f.getDefaultState(), Blocks.field_150344_f.getDefaultState(), false);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 5, 1, 9, 5, 2, Blocks.field_150344_f.getDefaultState(), Blocks.field_150344_f.getDefaultState(), false);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 5, 12, 9, 5, 13, Blocks.field_150344_f.getDefaultState(), Blocks.field_150344_f.getDefaultState(), false);
                        this.setBlockState(worldIn, Blocks.field_150344_f.getDefaultState(), 9, 5, 11, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.field_150344_f.getDefaultState(), 8, 5, 11, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.field_150344_f.getDefaultState(), 9, 5, 10, structureBoundingBoxIn);
    ...
    public static class PortalRoom extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 1, 1, 1, 1, 3, Blocks.field_150356_k.getDefaultState(), Blocks.field_150356_k.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 9, 1, 1, 9, 1, 3, Blocks.field_150356_k.getDefaultState(), Blocks.field_150356_k.getDefaultState(), false);
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 1, 9, 6, 1, 11, Blocks.field_150356_k.getDefaultState(), Blocks.field_150356_k.getDefaultState(), false);
                ...
                this.setBlockState(worldIn, iblockstate4.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[0])), 4, 3, 8, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate4.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[1])), 5, 3, 8, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate4.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[2])), 6, 3, 8, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[3])), 4, 3, 12, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[4])), 5, 3, 12, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[5])), 6, 3, 12, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate1.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[6])), 3, 3, 9, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate1.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[7])), 3, 3, 10, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate1.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[8])), 3, 3, 11, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate2.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[9])), 7, 3, 9, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate2.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[10])), 7, 3, 10, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate2.func_177226_a(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[11])), 7, 3, 11, structureBoundingBoxIn);
    ...
    public static class RoomCrossing extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                else
                {
                    ...
                    {
                        case 0:
                            this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 5, 1, 5, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 5, 2, 5, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 5, 3, 5, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.TORCH.getDefaultState().func_177226_a(BlockTorch.field_176596_a, EnumFacing.WEST), 4, 3, 5, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.TORCH.getDefaultState().func_177226_a(BlockTorch.field_176596_a, EnumFacing.EAST), 6, 3, 5, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.TORCH.getDefaultState().func_177226_a(BlockTorch.field_176596_a, EnumFacing.SOUTH), 5, 3, 4, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.TORCH.getDefaultState().func_177226_a(BlockTorch.field_176596_a, EnumFacing.NORTH), 5, 3, 6, structureBoundingBoxIn);
                        ...
                        case 1:
                            ...
                            {
                                this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 3, 1, 3 + i1, structureBoundingBoxIn);
                                this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 7, 1, 3 + i1, structureBoundingBoxIn);
                                this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 3 + i1, 1, 3, structureBoundingBoxIn);
                                this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 3 + i1, 1, 7, structureBoundingBoxIn);
                            }

                            this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 5, 1, 5, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 5, 2, 5, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 5, 3, 5, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.field_150358_i.getDefaultState(), 5, 4, 5, structureBoundingBoxIn);
                            break;
                        case 2:
                            ...
                            for (int l = 2; l <= 8; ++l)
                            {
                                this.setBlockState(worldIn, Blocks.field_150344_f.getDefaultState(), 2, 3, l, structureBoundingBoxIn);
                                this.setBlockState(worldIn, Blocks.field_150344_f.getDefaultState(), 3, 3, l, structureBoundingBoxIn);

                                if (l <= 3 || l >= 7)
                                {
                                    this.setBlockState(worldIn, Blocks.field_150344_f.getDefaultState(), 4, 3, l, structureBoundingBoxIn);
                                    this.setBlockState(worldIn, Blocks.field_150344_f.getDefaultState(), 5, 3, l, structureBoundingBoxIn);
                                    this.setBlockState(worldIn, Blocks.field_150344_f.getDefaultState(), 6, 3, l, structureBoundingBoxIn);
                                }

                                this.setBlockState(worldIn, Blocks.field_150344_f.getDefaultState(), 7, 3, l, structureBoundingBoxIn);
                                this.setBlockState(worldIn, Blocks.field_150344_f.getDefaultState(), 8, 3, l, structureBoundingBoxIn);
                            }
    ...
    public static class Stairs extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                else
                {
                    ...
                    this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 2, 6, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 1, 5, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STONE_SLAB.func_176203_a(BlockStoneSlab.EnumType.STONE.func_176624_a()), 1, 6, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 1, 5, 2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 1, 4, 3, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STONE_SLAB.func_176203_a(BlockStoneSlab.EnumType.STONE.func_176624_a()), 1, 5, 3, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 2, 4, 3, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 3, 3, 3, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STONE_SLAB.func_176203_a(BlockStoneSlab.EnumType.STONE.func_176624_a()), 3, 4, 3, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 3, 3, 2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 3, 2, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STONE_SLAB.func_176203_a(BlockStoneSlab.EnumType.STONE.func_176624_a()), 3, 3, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 2, 2, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 1, 1, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STONE_SLAB.func_176203_a(BlockStoneSlab.EnumType.STONE.func_176624_a()), 1, 2, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 1, 1, 2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STONE_SLAB.func_176203_a(BlockStoneSlab.EnumType.STONE.func_176624_a()), 1, 1, 3, structureBoundingBoxIn);
                    return true;
                }
            }
        }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < 6; ++i)
                    {
                        ...
                        if (i < 5)
                        {
                            this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 1, 5 - i, 1 + i, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 2, 5 - i, 1 + i, structureBoundingBoxIn);
                            this.setBlockState(worldIn, Blocks.field_150417_aV.getDefaultState(), 3, 5 - i, 1 + i, structureBoundingBoxIn);
                        }
                    }
