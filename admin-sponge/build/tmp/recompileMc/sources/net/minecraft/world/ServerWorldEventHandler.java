...
public class ServerWorldEventHandler implements IWorldEventListener
{
    ...
    {
        this.server.getPlayerList().sendToAllNearExcept(player, x, y, z, volume > 1.0F ? (double)(16.0F * volume) : 16.0D, this.world.dimension.getDimension(), new SPacketSoundEffect(soundIn, category, x, y, z, volume, pitch));
    }
    ...
    {
        this.server.getPlayerList().sendToAllNearExcept(player, (double)blockPosIn.getX(), (double)blockPosIn.getY(), (double)blockPosIn.getZ(), 64.0D, this.world.dimension.getDimension(), new SPacketEffect(type, blockPosIn, data, false));
    }
