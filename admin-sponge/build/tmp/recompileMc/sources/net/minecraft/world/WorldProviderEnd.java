...
public class WorldProviderEnd extends WorldProvider
{
    ...
    public void init()
    {
        ...
        NBTTagCompound nbttagcompound = this.world.getWorldInfo().getDimensionData(this.world.dimension.getDimension());
    ...
    public void onWorldSave()
    {
        ...
        this.world.getWorldInfo().setDimensionData(this.world.dimension.getDimension(), nbttagcompound);
    }
