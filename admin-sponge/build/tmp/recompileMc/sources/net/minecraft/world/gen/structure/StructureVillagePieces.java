    ...
    public static class Church extends StructureVillagePieces.Village
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                IBlockState iblockstate1 = this.getBiomeSpecificBlockState(Blocks.field_150446_ar.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.NORTH));
                IBlockState iblockstate2 = this.getBiomeSpecificBlockState(Blocks.field_150446_ar.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.WEST));
                IBlockState iblockstate3 = this.getBiomeSpecificBlockState(Blocks.field_150446_ar.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.EAST));
    ...
    public static class Field1 extends StructureVillagePieces.Village
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                IBlockState iblockstate = this.getBiomeSpecificBlockState(Blocks.field_150364_r.getDefaultState());
                ...
                for (int i = 1; i <= 7; ++i)
                {
                    ...
                    int k = j / 3;
                    this.setBlockState(worldIn, this.cropTypeA.func_176203_a(MathHelper.nextInt(randomIn, k, j)), 1, 1, i, structureBoundingBoxIn);
                    this.setBlockState(worldIn, this.cropTypeA.func_176203_a(MathHelper.nextInt(randomIn, k, j)), 2, 1, i, structureBoundingBoxIn);
                    int l = ((BlockCrops)this.cropTypeB).getMaxAge();
                    int i1 = l / 3;
                    this.setBlockState(worldIn, this.cropTypeB.func_176203_a(MathHelper.nextInt(randomIn, i1, l)), 4, 1, i, structureBoundingBoxIn);
                    this.setBlockState(worldIn, this.cropTypeB.func_176203_a(MathHelper.nextInt(randomIn, i1, l)), 5, 1, i, structureBoundingBoxIn);
                    int j1 = ((BlockCrops)this.cropTypeC).getMaxAge();
                    int k1 = j1 / 3;
                    this.setBlockState(worldIn, this.cropTypeC.func_176203_a(MathHelper.nextInt(randomIn, k1, j1)), 7, 1, i, structureBoundingBoxIn);
                    this.setBlockState(worldIn, this.cropTypeC.func_176203_a(MathHelper.nextInt(randomIn, k1, j1)), 8, 1, i, structureBoundingBoxIn);
                    int l1 = ((BlockCrops)this.cropTypeD).getMaxAge();
                    int i2 = l1 / 3;
                    this.setBlockState(worldIn, this.cropTypeD.func_176203_a(MathHelper.nextInt(randomIn, i2, l1)), 10, 1, i, structureBoundingBoxIn);
                    this.setBlockState(worldIn, this.cropTypeD.func_176203_a(MathHelper.nextInt(randomIn, i2, l1)), 11, 1, i, structureBoundingBoxIn);
                }
    ...
    public static class Hall extends StructureVillagePieces.Village
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                IBlockState iblockstate1 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.NORTH));
                IBlockState iblockstate2 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.SOUTH));
                IBlockState iblockstate3 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.WEST));
                IBlockState iblockstate4 = this.getBiomeSpecificBlockState(Blocks.field_150344_f.getDefaultState());
                IBlockState iblockstate5 = this.getBiomeSpecificBlockState(Blocks.field_150364_r.getDefaultState());
                ...
                this.setBlockState(worldIn, Blocks.field_150452_aw.getDefaultState(), 2, 2, 3, structureBoundingBoxIn);
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 0, 1, 7, 0, 3, Blocks.field_150334_T.getDefaultState(), Blocks.field_150334_T.getDefaultState(), false);
                this.setBlockState(worldIn, Blocks.field_150334_T.getDefaultState(), 6, 1, 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.field_150334_T.getDefaultState(), 6, 1, 2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.AIR.getDefaultState(), 2, 1, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.AIR.getDefaultState(), 2, 2, 0, structureBoundingBoxIn);
    ...
    public static class House1 extends StructureVillagePieces.Village
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                IBlockState iblockstate1 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.NORTH));
                IBlockState iblockstate2 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.SOUTH));
                IBlockState iblockstate3 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.EAST));
                IBlockState iblockstate4 = this.getBiomeSpecificBlockState(Blocks.field_150344_f.getDefaultState());
                IBlockState iblockstate5 = this.getBiomeSpecificBlockState(Blocks.field_150446_ar.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.NORTH));
                IBlockState iblockstate6 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
                ...
                this.setBlockState(worldIn, Blocks.field_150452_aw.getDefaultState(), 6, 2, 3, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate6, 4, 1, 3, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.field_150452_aw.getDefaultState(), 4, 2, 3, structureBoundingBoxIn);
    ...
    public static class House2 extends StructureVillagePieces.Village
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                IBlockState iblockstate = Blocks.COBBLESTONE.getDefaultState();
                IBlockState iblockstate1 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.NORTH));
                IBlockState iblockstate2 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.WEST));
                IBlockState iblockstate3 = this.getBiomeSpecificBlockState(Blocks.field_150344_f.getDefaultState());
                IBlockState iblockstate4 = this.getBiomeSpecificBlockState(Blocks.field_150446_ar.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.NORTH));
                IBlockState iblockstate5 = this.getBiomeSpecificBlockState(Blocks.field_150364_r.getDefaultState());
                IBlockState iblockstate6 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
                ...
                this.setBlockState(worldIn, Blocks.field_150356_k.getDefaultState(), 7, 1, 5, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.field_150356_k.getDefaultState(), 8, 1, 5, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.field_150334_T.getDefaultState(), 8, 1, 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.GLASS_PANE.getDefaultState(), 0, 2, 2, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.field_150452_aw.getDefaultState(), 2, 2, 4, structureBoundingBoxIn);
    ...
    public static class House3 extends StructureVillagePieces.Village
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                IBlockState iblockstate2 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.SOUTH));
                IBlockState iblockstate3 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.EAST));
                IBlockState iblockstate4 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.WEST));
                IBlockState iblockstate5 = this.getBiomeSpecificBlockState(Blocks.field_150344_f.getDefaultState());
                IBlockState iblockstate6 = this.getBiomeSpecificBlockState(Blocks.field_150364_r.getDefaultState());
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 1, 1, 7, 4, 4, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 1, 6, 8, 4, 10, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
    ...
    public static class House4Garden extends StructureVillagePieces.Village
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                IBlockState iblockstate = this.getBiomeSpecificBlockState(Blocks.COBBLESTONE.getDefaultState());
                IBlockState iblockstate1 = this.getBiomeSpecificBlockState(Blocks.field_150344_f.getDefaultState());
                IBlockState iblockstate2 = this.getBiomeSpecificBlockState(Blocks.field_150446_ar.getDefaultState().func_177226_a(BlockStairs.FACING, EnumFacing.NORTH));
                IBlockState iblockstate3 = this.getBiomeSpecificBlockState(Blocks.field_150364_r.getDefaultState());
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                for (int i = this.boundingBox.minX; i <= this.boundingBox.maxX; ++i)
                {
                    for (int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j)
                    {
                        ...
                        {
                            blockpos = worldIn.func_175672_r(blockpos).down();
    ...
    public static class Torch extends StructureVillagePieces.Village
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.setBlockState(worldIn, Blocks.field_150325_L.func_176203_a(EnumDyeColor.WHITE.func_176767_b()), 1, 3, 0, structureBoundingBoxIn);
    ...
    public abstract static class Village extends StructureComponent
        {
            ...
            protected int getAverageGroundLevel(World worldIn, StructureBoundingBox structurebb)
            {
                ...
                for (int k = this.boundingBox.minZ; k <= this.boundingBox.maxZ; ++k)
                {
                    for (int l = this.boundingBox.minX; l <= this.boundingBox.maxX; ++l)
                    {
                        ...
                        {
                            i += Math.max(worldIn.func_175672_r(blockpos$mutableblockpos).getY(), worldIn.dimension.func_76557_i() - 1);
                            ++j;
                        }
                    }
                }
                ...
                if (this.villagersSpawned < count)
                {
                    for (int i = this.villagersSpawned; i < count; ++i)
                    {
                        ...
                        if (this.isZombieInfested)
                        {
                            ...
                            entityzombievillager.func_180482_a(worldIn.getDifficultyForLocation(new BlockPos(entityzombievillager)), (IEntityLivingData)null);
            ...
            protected IBlockState getBiomeSpecificBlockState(IBlockState blockstateIn)
            {
                ...
                {
                    if (blockstateIn.getBlock() == Blocks.field_150364_r || blockstateIn.getBlock() == Blocks.field_150363_s)
                    {
                    ...
                    if (blockstateIn.getBlock() == Blocks.field_150344_f)
                    {
                    ...
                    {
                        return Blocks.SANDSTONE_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, blockstateIn.get(BlockStairs.FACING));
                    }

                    if (blockstateIn.getBlock() == Blocks.field_150446_ar)
                    {
                        return Blocks.SANDSTONE_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, blockstateIn.get(BlockStairs.FACING));
                    }
                ...
                else if (this.structureType == 3)
                {
                    if (blockstateIn.getBlock() == Blocks.field_150364_r || blockstateIn.getBlock() == Blocks.field_150363_s)
                    {
                        return Blocks.field_150364_r.getDefaultState().func_177226_a(BlockOldLog.field_176301_b, BlockPlanks.EnumType.SPRUCE).func_177226_a(BlockLog.field_176299_a, blockstateIn.get(BlockLog.field_176299_a));
                    }
                    ...
                    if (blockstateIn.getBlock() == Blocks.OAK_STAIRS)
                    {
                        return Blocks.SPRUCE_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, blockstateIn.get(BlockStairs.FACING));
                    }
                ...
                else if (this.structureType == 2)
                {
                    if (blockstateIn.getBlock() == Blocks.field_150364_r || blockstateIn.getBlock() == Blocks.field_150363_s)
                    {
                        return Blocks.field_150363_s.getDefaultState().func_177226_a(BlockNewLog.field_176300_b, BlockPlanks.EnumType.ACACIA).func_177226_a(BlockLog.field_176299_a, blockstateIn.get(BlockLog.field_176299_a));
                    }
                    ...
                    if (blockstateIn.getBlock() == Blocks.OAK_STAIRS)
                    {
                        return Blocks.ACACIA_STAIRS.getDefaultState().func_177226_a(BlockStairs.FACING, blockstateIn.get(BlockStairs.FACING));
                    }
    ...
    public static class Well extends StructureVillagePieces.Village
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 0, 1, 4, 12, 4, iblockstate, Blocks.field_150358_i.getDefaultState(), false);
    ...
    public static class WoodHut extends StructureVillagePieces.Village
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                if (this.tablePosition > 0)
                {
                    ...
                    this.setBlockState(worldIn, Blocks.field_150452_aw.getDefaultState(), this.tablePosition, 2, 3, structureBoundingBoxIn);
                }
