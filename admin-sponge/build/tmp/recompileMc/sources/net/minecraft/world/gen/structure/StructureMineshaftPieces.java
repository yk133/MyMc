    ...
    public static class Corridor extends StructureMineshaftPieces.Peice
        {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                else
                {
                    ...
                    if (this.hasSpiders)
                    {
                        this.generateMaybeBox(worldIn, structureBoundingBoxIn, randomIn, 0.6F, 0, 0, 0, 2, 1, i1, Blocks.field_150321_G.getDefaultState(), Blocks.AIR.getDefaultState(), false, 8);
                    }
    ...
    public static class Room extends StructureMineshaftPieces.Peice
        {
            ...
            protected void writeAdditional(NBTTagCompound tagCompound)
            {
                ...
                tagCompound.put("Entrances", nbttaglist);
            }
