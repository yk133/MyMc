...
public abstract class WorldGenAbstractTree extends WorldGenerator
{
    ...
    protected boolean canGrowInto(Block blockType)
    {
        ...
        return material == Material.AIR || material == Material.LEAVES || blockType == Blocks.GRASS || blockType == Blocks.DIRT || blockType == Blocks.field_150364_r || blockType == Blocks.field_150363_s || blockType == Blocks.field_150345_g || blockType == Blocks.VINE;
    }
    ...
    protected void setDirtAt(World worldIn, BlockPos pos)
    {
        ...
        {
            this.func_175903_a(worldIn, pos, Blocks.DIRT.getDefaultState());
        }
    }
