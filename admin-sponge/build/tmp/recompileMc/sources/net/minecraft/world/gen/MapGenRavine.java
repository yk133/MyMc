...
public class MapGenRavine extends MapGenBase
{
    ...
    {
        net.minecraft.block.Block block = data.func_177856_a(x, y, z).getBlock();
        return block== Blocks.field_150358_i || block == Blocks.WATER;
    }
    ...
    private boolean isExceptionBiome(net.minecraft.world.biome.Biome biome)
    {
        ...
        if (biome == net.minecraft.init.Biomes.MUSHROOM_FIELDS) return true;
        if (biome == net.minecraft.init.Biomes.MUSHROOM_FIELD_SHORE) return true;
        return false;
    }
    ...
    {
        net.minecraft.world.biome.Biome biome = field_75039_c.getBiome(new BlockPos(x + chunkX * 16, 0, z + chunkZ * 16));
        IBlockState state = data.func_177856_a(x, y, z);
        return (isExceptionBiome(biome) ? state.getBlock() == Blocks.GRASS : state.getBlock() == biome.field_76752_A);
    }
    ...
    protected void digBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop)
    {
        net.minecraft.world.biome.Biome biome = field_75039_c.getBiome(new BlockPos(x + chunkX * 16, 0, z + chunkZ * 16));
        IBlockState state = data.func_177856_a(x, y, z);
        IBlockState top = isExceptionBiome(biome) ? Blocks.GRASS.getDefaultState() : biome.field_76752_A;
        IBlockState filler = isExceptionBiome(biome) ? Blocks.DIRT.getDefaultState() : biome.field_76753_B;
        ...
        if (state.getBlock() == Blocks.STONE || state.getBlock() == top.getBlock() || state.getBlock() == filler.getBlock())
        {
            ...
            else
            {
                ...
                if (foundTop && data.func_177856_a(x, y - 1, z).getBlock() == filler.getBlock())
                {
                    data.func_177855_a(x, y - 1, z, top.getBlock().getDefaultState());
                }
            }
        }
    }
