...
public class VillageSiege
{
    ...
    private Vec3d findRandomSpawnPos(BlockPos pos)
    {
        for (int i = 0; i < 10; ++i)
        {
            ...
            if (this.village.isBlockPosWithinSqVillageRadius(blockpos) && WorldEntitySpawner.func_180267_a(EntityLiving.SpawnPlacementType.ON_GROUND, this.world, blockpos))
            {
