...
public class BlockWall extends Block
{
    ...
    private boolean func_176253_e(IBlockAccess p_176253_1_, BlockPos p_176253_2_, EnumFacing p_176253_3_)
    {
        ...
        BlockFaceShape blockfaceshape = iblockstate.getBlockFaceShape(p_176253_1_, p_176253_2_, p_176253_3_);
    ...
    {
        return Block.isExceptBlockForAttachWithPiston(p_194143_0_) || p_194143_0_ == Blocks.BARRIER || p_194143_0_ == Blocks.MELON || p_194143_0_ == Blocks.PUMPKIN || p_194143_0_ == Blocks.field_150428_aP;
    }
    ...
    {
        return func_176253_e(world, pos.offset(facing), facing.getOpposite());
    }
    ...
    private boolean canWallConnectTo(IBlockAccess world, BlockPos pos, EnumFacing facing)
    {
        ...
        return block.canBeConnectedTo(world, other, facing.getOpposite()) || func_176253_e(world, other, facing.getOpposite());
    }
