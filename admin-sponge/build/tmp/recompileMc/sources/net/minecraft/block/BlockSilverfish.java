...
public class BlockSilverfish extends Block
{
    ...
    {
        switch ((BlockSilverfish.EnumType)state.get(field_176378_a))
        {
            case COBBLESTONE:
    ...
    {
        if (!p_180653_1_.isRemote && p_180653_1_.getGameRules().getBoolean("doTileDrops"))
        {
            ...
            p_180653_1_.spawnEntity(entitysilverfish);
