...
public class TileEntityPiston extends TileEntity implements ITickable
{
    ...
    private void moveCollidedEntities(float p_184322_1_)
    {
        ...
        this.getCollisionRelatedBlockState().func_185908_a(this.world, BlockPos.ORIGIN, new AxisAlignedBB(BlockPos.ORIGIN), list, (Entity)null, true);
        ...
        if (!list.isEmpty())
        {
            ...
            if (!list1.isEmpty())
            {
                boolean flag = this.field_174932_a.getBlock().isStickyBlock(this.field_174932_a);
    ...
    {
        super.read(compound);
        this.field_174932_a = Block.getBlockById(compound.getInt("blockId")).func_176203_a(compound.getInt("blockData"));
