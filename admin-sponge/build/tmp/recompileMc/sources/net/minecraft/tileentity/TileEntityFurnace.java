...
public class TileEntityFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public void tick()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                if (!this.isBurning() && this.func_145948_k())
                {
            ...
            {
                flag1 = true;
                BlockFurnace.func_176446_a(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean func_145948_k()
    {
        ...
        {
            ItemStack itemstack = FurnaceRecipes.func_77602_a().func_151395_a(this.furnaceItemStacks.get(0));
    ...
    public void func_145949_j()
    {
        if (this.func_145948_k())
        {
            ...
            if (itemstack.getItem() == Item.getItemFromBlock(Blocks.SPONGE) && itemstack.func_77960_j() == 1 && !((ItemStack)this.furnaceItemStacks.get(1)).isEmpty() && ((ItemStack)this.furnaceItemStacks.get(1)).getItem() == Items.BUCKET)
            {
