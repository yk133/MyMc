...
public abstract class Container
{
    ...
    protected void slotChangedCraftingGrid(World worldIn, EntityPlayer playerIn, InventoryCrafting craftMatrixIn, InventoryCraftResult craftResultIn)
    {
        if (!worldIn.isRemote)
        {
            EntityPlayerMP entityplayermp = (EntityPlayerMP)playerIn;
            ItemStack itemstack = ItemStack.EMPTY;
            IRecipe irecipe = CraftingManager.func_192413_b(craftMatrixIn, worldIn);
            ...
            {
                craftResultIn.setRecipeUsed(irecipe);
