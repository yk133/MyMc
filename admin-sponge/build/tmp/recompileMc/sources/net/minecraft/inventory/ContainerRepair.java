    ...
    public ContainerRepair(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player)
    {
        ...
        this.addSlot(new Slot(this.outputSlot, 2, 134, 47)
        {
            ...
            public ItemStack onTake(EntityPlayer thePlayer, ItemStack stack)
            {
                ...
                if (!thePlayer.abilities.isCreativeMode && !worldIn.isRemote && iblockstate.getBlock() == Blocks.ANVIL && thePlayer.getRNG().nextFloat() < breakChance)
                {
                    ...
                    {
                        worldIn.setBlockState(blockPosIn, iblockstate.func_177226_a(BlockAnvil.field_176505_b, Integer.valueOf(l)), 2);
    ...
    public void updateRepairOutput()
    {
        ...
        else
        {
            ...
            if (!itemstack2.isEmpty())
            {
                ...
                flag = itemstack2.getItem() == Items.ENCHANTED_BOOK && !ItemEnchantedBook.getEnchantments(itemstack2).func_82582_d();
                ...
                else
                {
                    ...
                    if (itemstack1.isDamageable() && !flag)
                    {
                        ...
                        if (l1 < itemstack1.getDamage()) // vanilla uses metadata here instead of damage.
                        {
