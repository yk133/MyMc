...
public class CommandEffect extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                try
                {
                    potion = Potion.getPotionById(func_180528_a(p_184881_3_[1], 1));
                }
                ...
                else
                {
                    ...
                    if (j > 0)
                    {
                        ...
                        func_152373_a(p_184881_2_, this, "commands.effect.success", new Object[] {new TextComponentTranslation(potioneffect.getEffectName(), new Object[0]), Potion.getIdFromPotion(potion), k, entitylivingbase.func_70005_c_(), j});
                    }
    ...
    public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_)
    {
        ...
        {
            return func_175762_a(p_184883_3_, Potion.REGISTRY.getKeys());
        }
        else
        {
