...
public class CommandDebug extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (!p_184881_1_.profiler.profilingEnabled)
                {
                ...
                p_184881_1_.profiler.profilingEnabled = false;
    ...
    {
        List<Profiler.Result> list = p_184895_4_.profiler.getProfilingData(p_184895_2_);
        ...
        if (list != null && list.size() >= 3)
        {
            for (int i = 1; i < list.size(); ++i)
            {
                ...
                p_184895_3_.append(profiler$result.profilerName).append(" - ").append(String.format("%.2f", profiler$result.usePercentage)).append("%/").append(String.format("%.2f", profiler$result.totalUsePercentage)).append("%\n");

                if (!"unspecified".equals(profiler$result.profilerName))
                {
                    try
                    {
                        this.func_184895_a(p_184895_1_ + 1, p_184895_2_ + "." + profiler$result.profilerName, p_184895_3_, p_184895_4_);
                    }
