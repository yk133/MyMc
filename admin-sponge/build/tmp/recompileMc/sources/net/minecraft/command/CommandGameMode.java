...
public class CommandGameMode extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            if (p_184881_2_.getEntityWorld().getGameRules().getBoolean("sendCommandFeedback"))
            {
    ...
    protected GameType func_71539_b(ICommandSender p_71539_1_, String p_71539_2_) throws CommandException, NumberInvalidException
    {
        ...
        return gametype == GameType.NOT_SET ? WorldSettings.getGameTypeById(func_175764_a(p_71539_2_, 0, GameType.values().length - 2)) : gametype;
    }
