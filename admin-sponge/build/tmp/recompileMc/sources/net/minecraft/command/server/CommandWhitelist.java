...
public class CommandWhitelist extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            {
                p_184881_2_.sendMessage(new TextComponentTranslation("commands.whitelist.list", new Object[] {p_184881_1_.getPlayerList().getWhitelistedPlayerNames().length, p_184881_1_.getPlayerList().getAvailablePlayerDat().length}));
