...
public class CommandExecuteAt extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            ICommandSender icommandsender = CommandSenderWrapper.func_193998_a(p_184881_2_).func_193997_a(entity, new Vec3d(d0, d1, d2)).func_194001_a(p_184881_1_.worlds[0].getGameRules().getBoolean("commandBlockOutput"));
    ...
    public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_)
    {
        ...
        {
            return p_184883_3_.length == 9 && "detect".equals(p_184883_3_[4]) ? func_175762_a(p_184883_3_, Block.REGISTRY.getKeys()) : Collections.emptyList();
        }
    }
