...
public class GuiEnchantment extends GuiContainer
{
    ...
    {
        this.fontRenderer.func_78276_b(this.nameable.getDisplayName().func_150260_c(), 12, 5, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        GlStateManager.viewport((scaledresolution.func_78326_a() - 320) / 2 * scaledresolution.func_78325_e(), (scaledresolution.func_78328_b() - 240) / 2 * scaledresolution.func_78325_e(), 320 * scaledresolution.func_78325_e(), 240 * scaledresolution.func_78325_e());
        ...
        for (int l = 0; l < 3; ++l)
        {
            ...
            else
            {
                ...
                if (((k < l + 1 || this.mc.player.experienceLevel < k1) && !this.mc.player.abilities.isCreativeMode) || this.container.enchantClue[l] == -1) // Forge: render buttons as disabled when enchantable but enchantability not met on lower levels
                {
                    this.drawTexturedModalRect(i1, j + 14 + 19 * l, 0, 185, 108, 19);
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int j = 0; j < 3; ++j)
        {
            ...
            if (this.func_146978_c(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0)
            {
                List<String> list = Lists.<String>newArrayList();
                list.add("" + TextFormatting.WHITE + TextFormatting.ITALIC + I18n.format("container.enchant.clue", enchantment == null ? "" : enchantment.func_77316_c(l)));
