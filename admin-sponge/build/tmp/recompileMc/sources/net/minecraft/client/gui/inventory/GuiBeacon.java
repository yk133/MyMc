...
public class GuiBeacon extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        this.buttons.add(this.beaconConfirmButton);
        this.buttons.add(new GuiBeacon.CancelButton(-2, this.guiLeft + 190, this.guiTop + 107));
        ...
        if (this.buttonsNotDrawn && i >= 0)
        {
            ...
            for (int k = 0; k <= 2; ++k)
            {
                ...
                for (int j1 = 0; j1 < l; ++j1)
                {
                    ...
                    this.buttons.add(guibeacon$powerbutton);
            ...
            for (int j2 = 0; j2 < l1 - 1; ++j2)
            {
                ...
                this.buttons.add(guibeacon$powerbutton2);
            ...
            if (potion != null)
            {
                ...
                this.buttons.add(guibeacon$powerbutton1);
