...
public class GuiScreenOptionsSounds extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        int i = 0;
        this.buttons.add(new GuiScreenOptionsSounds.Button(SoundCategory.MASTER.ordinal(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), SoundCategory.MASTER, true));
        i = i + 2;
        ...
        for (SoundCategory soundcategory : SoundCategory.values())
        {
            ...
            {
                this.buttons.add(new GuiScreenOptionsSounds.Button(soundcategory.ordinal(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), soundcategory, false));
                ++i;
            }
        }
        ...
        ++i;
        this.buttons.add(new GuiOptionButton(201, j, k + 24 * (i >> 1), GameSettings.Options.SHOW_SUBTITLES, this.game_settings_4.getKeyBinding(GameSettings.Options.SHOW_SUBTITLES)));
    ...
    protected void func_146284_a(GuiButton p_146284_1_) throws IOException
    {
        if (p_146284_1_.enabled)
        {
            ...
            else if (p_146284_1_.id == 201)
            {
                ...
                p_146284_1_.displayString = this.mc.gameSettings.getKeyBinding(GameSettings.Options.SHOW_SUBTITLES);
                this.mc.gameSettings.saveOptions();
            }
        }
    }
    ...
    class Button extends GuiButton
    {
        ...
        public boolean func_146116_c(Minecraft p_146116_1_, int p_146116_2_, int p_146116_3_)
        {
            ...
            {
                this.volume = (float)(p_146116_2_ - (this.x + 4)) / (float)(this.width - 8);
                this.volume = MathHelper.clamp(this.volume, 0.0F, 1.0F);
                p_146116_1_.gameSettings.setSoundLevel(this.category, this.volume);
        ...
        public void func_146118_a(int p_146118_1_, int p_146118_2_)
        {
            if (this.pressed)
            {
                GuiScreenOptionsSounds.this.mc.getSoundHandler().play(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
            }
