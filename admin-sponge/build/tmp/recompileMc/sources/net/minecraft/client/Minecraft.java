...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    public Minecraft(GameConfiguration gameConfig)
    {
        ...
        this.field_71443_c = gameConfig.displayInfo.width > 0 ? gameConfig.displayInfo.width : 1;
        this.field_71440_d = gameConfig.displayInfo.height > 0 ? gameConfig.displayInfo.height : 1;
        this.field_71436_X = gameConfig.displayInfo.width;
        this.field_71435_Y = gameConfig.displayInfo.height;
        this.field_71431_Q = gameConfig.displayInfo.fullscreen;
    ...
    private void init() throws LWJGLException, IOException
    {
        ...
        net.minecraftforge.fml.client.FMLClientHandler.instance().beginMinecraftLoading(this, this.field_110449_ao, this.resourceManager, this.field_110452_an);
        ...
        net.minecraftforge.fml.client.SplashProgress.clearVanillaResources(textureManager, field_152354_ay);
    ...
    public void populateSearchTreeManager()
    {
        ...
        RecipeBookClient.field_194087_f.forEach(searchtree1::add);
    ...
    public void func_180510_a(TextureManager p_180510_1_) throws LWJGLException
    {
        ...
        GlStateManager.matrixMode(5889);
        GlStateManager.loadIdentity();
        GlStateManager.ortho(0.0D, (double)scaledresolution.func_78326_a(), (double)scaledresolution.func_78328_b(), 0.0D, 1000.0D, 3000.0D);
        GlStateManager.matrixMode(5888);
        GlStateManager.loadIdentity();
        ...
        bufferbuilder.pos(0.0D, (double)this.field_71440_d, 0.0D).tex(0.0D, 0.0D).color(255, 255, 255, 255).endVertex();
        bufferbuilder.pos((double)this.field_71443_c, (double)this.field_71440_d, 0.0D).tex(0.0D, 0.0D).color(255, 255, 255, 255).endVertex();
        bufferbuilder.pos((double)this.field_71443_c, 0.0D, 0.0D).tex(0.0D, 0.0D).color(255, 255, 255, 255).endVertex();
        bufferbuilder.pos(0.0D, 0.0D, 0.0D).tex(0.0D, 0.0D).color(255, 255, 255, 255).endVertex();
        tessellator.draw();
        GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
        int j = 256;
        int k = 256;
        this.draw((scaledresolution.func_78326_a() - 256) / 2, (scaledresolution.func_78328_b() - 256) / 2, 0, 0, 256, 256, 255, 255, 255, 255);
        GlStateManager.disableLighting();
        GlStateManager.disableFog();
    ...
    private void func_71411_J() throws IOException
    {
        ...
        while (func_71386_F() >= this.debugUpdateTime + 1000L)
        {
            ...
            this.debug = String.format("%d fps (%d chunk update%s) T: %s%s%s%s%s", debugFPS, RenderChunk.renderChunksUpdated, RenderChunk.renderChunksUpdated == 1 ? "" : "s", (float)this.gameSettings.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.func_148267_f() ? "inf" : this.gameSettings.limitFramerate, this.gameSettings.enableVsync ? " vsync" : "", this.gameSettings.fancyGraphics ? "" : " fast", this.gameSettings.clouds == 0 ? "" : (this.gameSettings.clouds == 1 ? " fast-clouds" : " fancy-clouds"), OpenGlHelper.useVbo() ? " vbo" : "");
    ...
    private void func_71366_a(long p_71366_1_)
    {
        if (this.profiler.profilingEnabled)
        {
            ...
            GlStateManager.loadIdentity();
            GlStateManager.ortho(0.0D, (double)this.field_71443_c, (double)this.field_71440_d, 0.0D, 1000.0D, 3000.0D);
            GlStateManager.matrixMode(5888);
            GlStateManager.loadIdentity();
            GlStateManager.translatef(0.0F, 0.0F, -2000.0F);
        ...
        if (!this.playerController.getIsHittingBlock())
        {
            ...
            if (!this.player.isRowingBoat())
            {
                ...
                for (EnumHand enumhand : EnumHand.values())
                {
                    ...
                    if (itemstack.isEmpty() && (this.objectMouseOver == null || this.objectMouseOver.type == RayTraceResult.Type.MISS)) net.minecraftforge.common.ForgeHooks.onEmptyClick(this.player, enumhand);
    ...
    public void func_71370_a(int p_71370_1_, int p_71370_2_)
    {
        ...
        {
            ScaledResolution scaledresolution = new ScaledResolution(this);
            this.currentScreen.onResize(this, scaledresolution.func_78326_a(), scaledresolution.func_78328_b());
        }
    ...
    {
        this.framebuffer.createBindFramebuffer(this.field_71443_c, this.field_71440_d);

        if (this.entityRenderer != null)
        {
            this.entityRenderer.updateShaderGroupSize(this.field_71443_c, this.field_71440_d);
        }
    }
    ...
    public void launchIntegratedServer(String folderName, String worldName, @Nullable WorldSettings worldSettingsIn)
    {
        ...
        this.loadWorld((WorldClient)null);
        System.gc();
        ISaveHandler isavehandler = this.saveLoader.func_75804_a(folderName, false);
    ...
    public void func_71353_a(@Nullable WorldClient p_71353_1_, String p_71353_2_)
    {
        ...
        if (p_71353_1_ == null)
        {
            ...
            if (this.integratedServer != null && this.integratedServer.isAnvilFileSet())
            {
                ...
                if (field_71461_s != null && this.running)
                {
                    this.field_71461_s.func_73719_c(I18n.format("forge.client.shutdown.internal"));
                }
        ...
        if (p_71353_1_ != null)
        {
            ...
            p_71353_1_.spawnEntity(this.player);
    ...
    public ItemStack storeTEInStack(ItemStack stack, TileEntity te)
    {
        ...
        if (stack.getItem() == Items.field_151144_bL && nbttagcompound.contains("Owner"))
        {
            ...
            nbttagcompound3.put("SkullOwner", nbttagcompound2);
    ...
    public void addServerStatsToSnooper(Snooper playerSnooper)
    {
        ...
        playerSnooper.addClientStat("display_type", this.field_71431_Q ? "fullscreen" : "windowed");
        playerSnooper.addClientStat("run_time", Long.valueOf((MinecraftServer.func_130071_aq() - playerSnooper.getMinecraftStartTimeMillis()) / 60L * 1000L));
        ...
        playerSnooper.addClientStat("resource_packs", Integer.valueOf(this.resourcePackRepository.func_110613_c().size()));
        int i = 0;

        for (ResourcePackRepository.Entry resourcepackrepository$entry : this.resourcePackRepository.func_110613_c())
        {
            playerSnooper.addClientStat("resource_pack[" + i++ + "]", resourcepackrepository$entry.func_110515_d());
        }
    ...
    {
        p_70001_1_.addStatToSnooper("opengl_version", GlStateManager.getString(7938));
        p_70001_1_.addStatToSnooper("opengl_vendor", GlStateManager.getString(7936));
        ...
        GlStateManager.getError();
        p_70001_1_.addStatToSnooper("gl_max_texture_size", Integer.valueOf(getGLMaximumTextureSize()));
    ...
    public MusicTicker.MusicType getAmbientMusicType()
    {
        ...
        {
            MusicTicker.MusicType type = this.world.dimension.getMusicType();
