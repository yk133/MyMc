...
public class GuiButtonRecipe extends GuiButton
{
    ...
    public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_)
    {
        if (this.visible)
        {
            ...
            {
                p_191745_1_.getItemRenderer().renderItemAndEffectIntoGUI(itemstack, this.x + k + 1, this.y + k + 1);
                --k;
            }

            p_191745_1_.getItemRenderer().renderItemAndEffectIntoGUI(itemstack, this.x + k, this.y + k);
