...
public class WorldClient extends World
{
    ...
    protected void playMoodSoundAndCheckLight(int x, int z, Chunk chunkIn)
    {
        ...
        if (this.ambienceTicks == 0)
        {
            ...
            IBlockState iblockstate = chunkIn.func_177435_g(blockpos);
            j = j + x;
            k = k + z;

            if (iblockstate.getMaterial() == Material.AIR && this.func_175699_k(blockpos) <= this.rand.nextInt(8) && this.getLightFor(EnumSkyBlock.SKY, blockpos) <= 0)
            {
