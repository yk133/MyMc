...
public class GameSettings
{
    ...
    public void setOptionValue(GameSettings.Options settingsOption, int value)
    {
        ...
        {
            this.func_74304_a(settingsOption, MathHelper.clamp((float)(this.renderDistanceChunks + value), settingsOption.func_186707_e(), settingsOption.func_148267_f()));
        }
    ...
    public String getKeyBinding(GameSettings.Options settingOption)
    {
        ...
        {
            float f1 = this.func_74296_a(settingOption);
            float f = settingOption.func_148266_c(f1);
        ...
        {
            return s + getTranslation(field_74367_ae, this.guiScale);
        }
    ...
    public void saveOptions()
    {
        ...
        try
        {
            ...
            for (KeyBinding keybinding : this.keyBindings)
            {
                String keyString = "key_" + keybinding.getKeyDescription() + ":" + keybinding.func_151463_i();
    ...
    public static enum Options
    {
        ...
        {
            this.translation = p_i45004_3_;
            this.isFloat = p_i45004_4_;
            this.isBoolean = p_i45004_5_;
        ...
        {
            return MathHelper.clamp((this.func_148268_e(p_148266_1_) - this.valueMin) / (this.valueMax - this.valueMin), 0.0F, 1.0F);
        }

        public float func_148262_d(float p_148262_1_)
        {
            return this.func_148268_e(this.valueMin + (this.valueMax - this.valueMin) * MathHelper.clamp(p_148262_1_, 0.0F, 1.0F));
        }
