...
public class TileEntityBedRenderer extends TileEntitySpecialRenderer<TileEntityBed>
{
    ...
    {
        this.field_193850_e = this.model.func_193770_a();
    }
    ...
    {
        if (this.field_193850_e != this.model.func_193770_a())
        {
        ...
        {
            ResourceLocation resourcelocation = TEXTURES[enumdyecolor.func_176765_a()];
    ...
    private void func_193847_a(boolean p_193847_1_, double p_193847_2_, double p_193847_4_, double p_193847_6_, int p_193847_8_, float p_193847_9_)
    {
        ...
        GlStateManager.translatef((float)p_193847_2_ + f1, (float)p_193847_4_ + 0.5625F, (float)p_193847_6_ + f2);
        ...
        this.model.render();
        GlStateManager.popMatrix();
        GlStateManager.color4f(1.0F, 1.0F, 1.0F, p_193847_9_);
        GlStateManager.popMatrix();
    }
