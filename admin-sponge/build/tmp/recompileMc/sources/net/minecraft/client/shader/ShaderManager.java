...
public class ShaderManager
{
    ...
    public ShaderManager(IResourceManager resourceManager, String programName) throws JsonException, IOException
    {
        ...
        String[] rl = ResourceLocation.func_177516_a(programName);
        ...
        try
        {
            ...
            this.vertexShaderLoader = ShaderLoader.func_148057_a(resourceManager, ShaderLoader.ShaderType.VERTEX, s);
            this.fragmentShaderLoader = ShaderLoader.func_148057_a(resourceManager, ShaderLoader.ShaderType.FRAGMENT, s1);
    ...
    {
        ShaderUniform shaderuniform = this.getShaderUniform(p_147984_1_);
