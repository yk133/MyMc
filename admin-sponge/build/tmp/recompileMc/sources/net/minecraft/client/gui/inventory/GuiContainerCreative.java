...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    public void initGui()
    {
        if (this.mc.playerController.isInCreativeMode())
        {
            ...
            int tabCount = CreativeTabs.GROUPS.length;
            if (tabCount > 12)
            {
                buttons.add(new GuiButton(101, guiLeft,              guiTop - 50, 20, 20, "<"));
                buttons.add(new GuiButton(102, guiLeft + xSize - 20, guiTop - 50, 20, 20, ">"));
    ...
    {
        if (!CreativeTabs.GROUPS[selectedTabIndex].hasSearchBar())
        {
    ...
    private void updateCreativeSearch()
    {
        ...
        CreativeTabs tab = CreativeTabs.GROUPS[selectedTabIndex];
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        if (creativetabs != null && creativetabs.drawInForegroundOfTab())
        {
            ...
            this.fontRenderer.func_78276_b(I18n.format(creativetabs.getTranslationKey()), 8, 6, creativetabs.getLabelColor());
        }
    }
    ...
    {
        if (CreativeTabs.GROUPS[selectedTabIndex] == null) return false;
        return selectedTabIndex != CreativeTabs.INVENTORY.getIndex() && CreativeTabs.GROUPS[selectedTabIndex].hasScrollbar() && ((GuiContainerCreative.ContainerCreative)this.inventorySlots).canScroll();
    }
                ...
                if (hotbarsnapshot.isEmpty())
                {
                    for (int k = 0; k < 9; ++k)
                    {
                        if (k == j)
                        {
                            ...
                            String s = GameSettings.func_74298_c(this.mc.gameSettings.keyBindsHotbar[j].func_151463_i());
                            String s1 = GameSettings.func_74298_c(this.mc.gameSettings.keyBindSaveToolbar.func_151463_i());
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (!this.field_147065_z && flag && mouseX >= k && mouseY >= l && mouseX < i1 && mouseY < j1)
        {
        ...
        int end = Math.min(CreativeTabs.GROUPS.length, ((tabPage + 1) * 10) + 2);
        if (tabPage != 0) start += 2;
        boolean rendered = false;

        for (CreativeTabs creativetabs : java.util.Arrays.copyOfRange(CreativeTabs.GROUPS,start,end))
        {
        ...
        if (this.destroyItemSlot != null && selectedTabIndex == CreativeTabs.INVENTORY.getIndex() && this.func_146978_c(this.destroyItemSlot.xPos, this.destroyItemSlot.yPos, 16, 16, mouseX, mouseY))
        {
        ...
        if (maxPages != 0)
        {
            ...
            fontRenderer.func_78276_b(page, guiLeft + (xSize / 2) - (width / 2), guiTop - 44, -1);
            this.zLevel = 0.0F;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        for (CreativeTabs creativetabs1 : java.util.Arrays.copyOfRange(CreativeTabs.GROUPS,start,end))
        {
    ...
    protected boolean func_147049_a(CreativeTabs p_147049_1_, int p_147049_2_, int p_147049_3_)
    {
        ...
        {
            if (p_147049_1_ != CreativeTabs.SEARCH && p_147049_1_ != CreativeTabs.INVENTORY)
            {
                return false;
            }
        }
