...
public class RenderPainting extends Render<EntityPainting>
{
    ...
    public void doRender(EntityPainting entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        this.renderPainting(entity, entitypainting$enumart.field_75703_B, entitypainting$enumart.field_75704_C, entitypainting$enumart.field_75699_D, entitypainting$enumart.field_75700_E);
