...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    private boolean isHeadspaceFree(BlockPos pos, int height)
    {
        ...
        {
            if (!func_175162_d(pos.add(0, y, 0))) return false;
        }
        return true;
    }
    ...
    {
        IBlockState iblockstate = world.getBlockState(p_175162_1_);
        return !iblockstate.getBlock().isNormalCube(iblockstate, world, p_175162_1_);
    }
    ...
    public void livingTick()
    {
        ...
        if (this.inPortal)
        {
            ...
            {
                this.mc.getSoundHandler().play(PositionedSoundRecord.getMasterRecord(SoundEvents.BLOCK_PORTAL_TRIGGER, this.rand.nextFloat() * 0.4F + 0.8F));
            }
