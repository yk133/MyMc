...
public class GuiMemoryErrorScreen extends GuiScreen
{
    ...
    {
        this.buttons.clear();
        this.buttons.add(new GuiOptionButton(0, this.width / 2 - 155, this.height / 4 + 120 + 12, I18n.format("gui.toTitle")));
        this.buttons.add(new GuiOptionButton(1, this.width / 2 - 155 + 160, this.height / 4 + 120 + 12, I18n.format("menu.quit")));
    }
