...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttons.add(new GuiButton(0, this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("gui.done")));
        this.buttons.add(new GuiButton(5, this.width / 2 + 5, this.height - 52, 150, 20, I18n.format("createWorld.customize.presets")));
    ...
    protected void func_146284_a(GuiButton p_146284_1_) throws IOException
    {
        ...
        else if (p_146284_1_.id == 4 && this.hasSelectedLayer())
        {
    ...
    class Details extends GuiSlot
    {
        ...
        {
            this.selectedLayer = p_148144_1_;
        ...
        protected void drawSlot(int slotIndex, int xPos, int yPos, int heightIn, int mouseXIn, int mouseYIn, float partialTicks)
        {
            ...
            GuiCreateFlatWorld.this.fontRenderer.func_78276_b(s, xPos + 18 + 5, yPos + 3, 16777215);
            String s1;
            ...
            GuiCreateFlatWorld.this.fontRenderer.func_78276_b(s1, xPos + 2 + 213 - GuiCreateFlatWorld.this.fontRenderer.getStringWidth(s1), yPos + 3, 16777215);
        }
