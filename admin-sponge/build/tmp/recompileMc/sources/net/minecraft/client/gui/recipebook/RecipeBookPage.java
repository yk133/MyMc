...
public class RecipeBookPage
{
    ...
    public void render(int p_194191_1_, int p_194191_2_, int p_194191_3_, int p_194191_4_, float p_194191_5_)
    {
        if (this.totalPages > 1)
        {
            ...
            this.minecraft.fontRenderer.func_78276_b(s, p_194191_1_ - i / 2 + 73, p_194191_2_ + 141, -1);
        }
        ...
        {
            guibuttonrecipe.func_191745_a(this.minecraft, p_194191_3_, p_194191_4_, p_194191_5_);
        ...
        this.backButton.func_191745_a(this.minecraft, p_194191_3_, p_194191_4_, p_194191_5_);
        this.forwardButton.func_191745_a(this.minecraft, p_194191_3_, p_194191_4_, p_194191_5_);
        ...
        else
        {
            for (GuiButtonRecipe guibuttonrecipe : this.buttons)
            {
                if (guibuttonrecipe.func_146116_c(this.minecraft, p_194196_1_, p_194196_2_))
                {
                    ...
                    {
                        this.overlay.func_191845_a(this.minecraft, guibuttonrecipe.getList(), guibuttonrecipe.x, guibuttonrecipe.y, p_194196_4_ + p_194196_6_ / 2, p_194196_5_ + 13 + p_194196_7_ / 2, (float)guibuttonrecipe.getWidth(), this.recipeBook);
                    }
