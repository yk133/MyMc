...
public class RenderFallingBlock extends Render<EntityFallingBlock>
{
    ...
    public void doRender(EntityFallingBlock entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        {
            IBlockState iblockstate = entity.func_175131_l();
            ...
            if (iblockstate.getRenderType() == EnumBlockRenderType.MODEL)
            {
                ...
                if (iblockstate != world.getBlockState(new BlockPos(entity)) && iblockstate.getRenderType() != EnumBlockRenderType.INVISIBLE)
                {
                    ...
                    blockrendererdispatcher.getBlockModelRenderer().func_187493_a(world, blockrendererdispatcher.getModelForState(iblockstate), iblockstate, blockpos, bufferbuilder, false, MathHelper.getPositionRandom(entity.getOrigin()));
                    tessellator.draw();
