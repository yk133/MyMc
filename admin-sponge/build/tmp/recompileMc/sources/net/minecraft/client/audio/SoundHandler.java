...
public class SoundHandler implements IResourceManagerReloadListener, ITickable
{
    ...
    public void func_110549_a(IResourceManager p_110549_1_)
    {
        ...
        {
            SoundEventAccessor soundeventaccessor = (SoundEventAccessor)this.soundRegistry.get(resourcelocation);
        ...
        {
            if (SoundEvent.REGISTRY.get(resourcelocation1) == null)
            {
    ...
    {
        SoundEventAccessor soundeventaccessor = (SoundEventAccessor)this.soundRegistry.get(location);
            ...
            switch (sound.getType())
            {
                ...
                case SOUND_EVENT:
                    isoundeventaccessor = new ISoundEventAccessor<Sound>()
                    {
                        ...
                        {
                            SoundEventAccessor soundeventaccessor1 = (SoundEventAccessor)SoundHandler.this.soundRegistry.get(resourcelocation);
    ...
    {
        return (SoundEventAccessor)this.soundRegistry.get(location);
    }
