...
public abstract class GuiSlot
{
    ...
    {
        return p_148141_1_ >= this.top && p_148141_1_ <= this.bottom && this.field_148150_g >= this.left && this.field_148150_g <= this.right;
    }
    ...
    public void func_178039_p()
    {
        ...
        {
            if (Mouse.getEventButton() == 0 && Mouse.getEventButtonState() && this.field_148162_h >= this.top && this.field_148162_h <= this.bottom)
            {
                int i = (this.width - this.getListWidth()) / 2;
                int j = (this.width + this.getListWidth()) / 2;
                int k = this.field_148162_h - this.top - this.headerPadding + (int)this.amountScrolled - 4;
                int l = k / this.slotHeight;

                if (l < this.getSize() && this.field_148150_g >= i && this.field_148150_g <= j && l >= 0 && k >= 0)
                {
                ...
                {
                    this.clickedHeader(this.field_148150_g - i, this.field_148162_h - this.top + (int)this.amountScrolled - 4);
                }
            }
            ...
            if (Mouse.isButtonDown(0) && this.func_148125_i())
            {
                if (this.initialClickY == -1)
                {
                    ...
                    if (this.field_148162_h >= this.top && this.field_148162_h <= this.bottom)
                    {
                        int j2 = (this.width - this.getListWidth()) / 2;
                        int k2 = (this.width + this.getListWidth()) / 2;
                        int l2 = this.field_148162_h - this.top - this.headerPadding + (int)this.amountScrolled - 4;
                        int i1 = l2 / this.slotHeight;

                        if (i1 < this.getSize() && this.field_148150_g >= j2 && this.field_148150_g <= k2 && i1 >= 0 && l2 >= 0)
                        {
                        ...
                        {
                            this.clickedHeader(this.field_148150_g - j2, this.field_148162_h - this.top + (int)this.amountScrolled - 4);
                            flag1 = false;
                        }
                        ...
                        if (this.field_148150_g >= i3 && this.field_148150_g <= j1)
                        {
                            ...
                            this.field_148170_p /= (float)(this.bottom - this.top - l1) / (float)k1;
                        }
                        else
                        {
                            this.field_148170_p = 1.0F;
                        ...
                        if (flag1)
                        {
                            this.initialClickY = this.field_148162_h;
                        }
                        else
                        {
                            this.initialClickY = -2;
                ...
                {
                    this.amountScrolled -= (float)(this.field_148162_h - this.initialClickY) * this.field_148170_p;
                    this.initialClickY = this.field_148162_h;
                }
            }
            else
