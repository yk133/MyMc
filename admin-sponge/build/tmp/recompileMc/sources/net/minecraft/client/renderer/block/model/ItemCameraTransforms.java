...
public class ItemCameraTransforms
{
    ...
    public static void applyTransformSide(ItemTransformVec3f vec, boolean leftHand)
    {
        ...
        {
            int i = leftHand ? -1 : 1;
            GlStateManager.translatef((float)i * (offsetTranslateX + vec.translation.x), offsetTranslateY + vec.translation.y, offsetTranslateZ + vec.translation.z);
            ...
            GlStateManager.scalef(offsetScaleX + vec.scale.x, offsetScaleY + vec.scale.y, offsetScaleZ + vec.scale.z);
        }
    }
