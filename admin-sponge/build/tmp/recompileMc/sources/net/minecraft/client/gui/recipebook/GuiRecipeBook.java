...
public class GuiRecipeBook extends Gui implements IRecipeUpdateListener
{
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        if (this.isVisible())
        {
            ...
            for (GuiButtonRecipeTab guibuttonrecipetab : this.recipeTabs)
            {
                guibuttonrecipetab.func_191745_a(this.mc, mouseX, mouseY, partialTicks);
            }

            this.toggleRecipesBtn.func_191745_a(this.mc, mouseX, mouseY, partialTicks);
    ...
    public boolean func_191859_a(char p_191859_1_, int p_191859_2_)
    {
        if (this.isVisible() && !this.mc.player.isSpectator())
        {
            ...
            {
                if (GameSettings.func_100015_a(this.mc.gameSettings.keyBindChat) && !this.searchBar.isFocused())
                {
