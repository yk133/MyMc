...
public class PlayerControllerMP
{
    ...
    public boolean onPlayerDestroyBlock(BlockPos pos)
    {
        ...
        else
        {
            ...
            {
                world.playEvent(2001, pos, Block.func_176210_f(iblockstate));
    ...
    public EnumActionResult processRightClickBlock(EntityPlayerSP player, WorldClient worldIn, BlockPos pos, EnumFacing direction, Vec3d vec, EnumHand hand)
    {
        ...
        else
        {
            ...
            if (this.currentGameType != GameType.SPECTATOR)
            {
                ...
                {
                    if (event.getUseBlock() != net.minecraftforge.fml.common.eventhandler.Event.Result.DENY)
                    flag = iblockstate.getBlock().func_180639_a(worldIn, pos, iblockstate, player, hand, direction, f, f1, f2);
                ...
                if (!flag && itemstack.getItem() instanceof ItemBlock)
                {
                    ...
                    if (!itemblock.func_179222_a(worldIn, pos, direction, player, itemstack))
                    {
                        return EnumActionResult.FAIL;
                    }
                }
            ...
            if (!flag && this.currentGameType != GameType.SPECTATOR || event.getUseItem() == net.minecraftforge.fml.common.eventhandler.Event.Result.ALLOW)
            {
                ...
                {
                    if (itemstack.getItem() instanceof ItemBlock && !player.func_189808_dh())
                    {
                    ...
                    if (this.currentGameType.isCreative())
                    {
                        ...
                        EnumActionResult enumactionresult = itemstack.func_179546_a(player, worldIn, pos, hand, direction, f, f1, f2);
                    ...
                    else
                    {
                        ...
                        if (event.getUseItem() != net.minecraftforge.fml.common.eventhandler.Event.Result.DENY)
                        result = itemstack.func_179546_a(player, worldIn, pos, hand, direction, f, f1, f2);
