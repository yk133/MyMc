...
public class GuiScreenBook extends GuiScreen
{
    ...
    public GuiScreenBook(EntityPlayer player, ItemStack book, boolean isUnsigned)
    {
        ...
        if (book.hasTag())
        {
            ...
            {
                this.bookPages.func_74742_a(new NBTTagString("")); // Forge: fix MC-1685
    ...
    private void sendBookToServer(boolean publish) throws IOException
    {
        if (this.bookIsUnsigned && this.bookIsModified)
        {
            if (this.bookPages != null)
            {
                ...
                {
                    String s = this.bookPages.getString(this.bookPages.func_74745_c() - 1);
                ...
                if (this.book.hasTag())
                {
                    ...
                    nbttagcompound.put("pages", this.bookPages);
                }
                else
                {
                ...
                {
                    s1 = "MC|BSign";
                    this.book.setTagInfo("author", new NBTTagString(this.editingPlayer.func_70005_c_()));
    ...
    {
        if (GuiScreen.isKeyComboCtrlV(p_146463_2_))
        {
    ...
    {
        return this.bookPages != null && this.currPage >= 0 && this.currPage < this.bookPages.func_74745_c() ? this.bookPages.getString(this.currPage) : "";
    }
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.bookGettingSigned)
        {
            ...
            this.fontRenderer.func_78276_b(s1, i + 36 + (116 - k) / 2, 34, 0);
            int l = this.fontRenderer.getStringWidth(s);
            this.fontRenderer.func_78276_b(s, i + 36 + (116 - l) / 2, 50, 0);
            String s2 = I18n.format("book.byAuthor", this.editingPlayer.func_70005_c_());
            int i1 = this.fontRenderer.getStringWidth(s2);
            this.fontRenderer.func_78276_b(TextFormatting.DARK_GRAY + s2, i + 36 + (116 - i1) / 2, 60, 0);
        ...
        else
        {
            ...
            this.fontRenderer.func_78276_b(s4, i - j1 + 192 - 44, 18, 0);
            ...
            else
            {
                ...
                for (int l1 = 0; l1 < k1; ++l1)
                {
                    ...
                    this.fontRenderer.func_78276_b(itextcomponent2.func_150260_c(), i + 36, 34 + l1 * this.fontRenderer.FONT_HEIGHT, 0);
                }
