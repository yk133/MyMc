...
public class GuiMerchant extends GuiContainer
{
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        this.fontRenderer.func_78276_b(s, this.xSize / 2 - this.fontRenderer.getStringWidth(s) / 2, 6, 4210752);
    ...
    protected void func_146284_a(GuiButton p_146284_1_) throws IOException
    {
        ...
        if (p_146284_1_ == this.nextButton)
        {
        ...
        else if (p_146284_1_ == this.previousButton)
        {
            --this.selectedMerchantRecipe;
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (merchantrecipelist != null && !merchantrecipelist.isEmpty())
        {
            ...
            if (this.func_146978_c(36, 24, 16, 16, mouseX, mouseY) && !itemstack.isEmpty())
            {
                this.renderToolTip(itemstack, mouseX, mouseY);
            }
            else if (!itemstack1.isEmpty() && this.func_146978_c(62, 24, 16, 16, mouseX, mouseY) && !itemstack1.isEmpty())
            {
                this.renderToolTip(itemstack1, mouseX, mouseY);
            }
            else if (!itemstack2.isEmpty() && this.func_146978_c(120, 24, 16, 16, mouseX, mouseY) && !itemstack2.isEmpty())
            {
                this.renderToolTip(itemstack2, mouseX, mouseY);
            }
            else if (merchantrecipe.isRecipeDisabled() && (this.func_146978_c(83, 21, 28, 21, mouseX, mouseY) || this.func_146978_c(83, 51, 28, 21, mouseX, mouseY)))
            {
