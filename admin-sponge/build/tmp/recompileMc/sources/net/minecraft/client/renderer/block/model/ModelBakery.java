...
public class ModelBakery
{
    ...
    protected static final ModelBlock MODEL_GENERATED = ModelBlock.deserialize(field_188643_q);
    protected static final ModelBlock MODEL_ENTITY = ModelBlock.deserialize(field_188643_q);
    ...
    protected void func_177569_a(ModelBlockDefinition p_177569_1_, ModelResourceLocation p_177569_2_)
    {
        try
        {
    ...
    protected void func_188638_a(ModelResourceLocation p_188638_1_, VariantList p_188638_2_)
    {
    ...
    protected List<String> func_177596_a(Item p_177596_1_)
    {
        ...
        if (list == null)
        {
            list = Collections.<String>singletonList(((ResourceLocation)Item.REGISTRY.getKey(p_177596_1_)).toString());
        }
    ...
    private void func_177588_f()
    {
        ...
        for (Entry<ModelBlockDefinition, Collection<ModelResourceLocation>> entry : this.field_188642_k.entrySet())
        {
            ...
            String s = ((ResourceLocation)Block.REGISTRY.getKey(multipart.func_188135_c().getOwner())).toString();
            ...
            for (ModelResourceLocation modelresourcelocation1 : entry.getValue())
            {
                ...
                {
                    this.bakedRegistry.put(modelresourcelocation1, ibakedmodel2);
                }
            }
        }
    }
        ...
        else
        {
            ...
            for (Variant variant : p_188639_1_.getVariantList())
            {
                ...
                if (modelblock != null && modelblock.isResolved())
                {
                    ...
                    {
                        IBakedModel ibakedmodel = this.func_177578_a(modelblock, variant.getRotation(), variant.isUvLock());
    ...
    private void func_188635_i()
    {
        for (Entry<String, ResourceLocation> entry : this.field_177615_s.entrySet())
        {
            ...
            if (modelblock != null && modelblock.isResolved())
            {
                ...
                {
                    this.bakedRegistry.put(modelresourcelocation, new BuiltInModel(modelblock.getAllTransforms(), modelblock.func_187967_g()));
                }
                else
                {
        ...
        for (ModelBlockDefinition modelblockdefinition : this.field_188642_k.keySet())
        {
            for (VariantList variantlist1 : modelblockdefinition.getMultipartData().getVariants())
            {
                for (Variant variant1 : variantlist1.getVariantList())
                {
                    ...
                    if (modelblock1 == null)
                    {
                        LOGGER.warn("Missing model for: {}", Block.REGISTRY.getKey(modelblockdefinition.getMultipartData().func_188135_c().getOwner()));
                    }
                    else
                    {
    ...
    {
        TextureAtlasSprite textureatlassprite = this.field_177599_g.get(new ResourceLocation(p_177578_1_.resolveTextureName("particle")));
        ...
        else
        {
            for (BlockPart blockpart : p_177578_1_.getElements())
            {
                for (EnumFacing enumfacing : blockpart.mapFaces.keySet())
                {
                    ...
                    TextureAtlasSprite textureatlassprite1 = this.field_177599_g.get(new ResourceLocation(p_177578_1_.resolveTextureName(blockpartface.texture)));

                    if (blockpartface.cullFace == null || !net.minecraftforge.common.model.TRSRTransformation.isInteger(p_177578_2_.getMatrix()))
                    {
                        simplebakedmodel$builder.addGeneralQuad(this.makeBakedQuad(blockpart, blockpartface, textureatlassprite1, enumfacing, p_177578_2_, p_177578_3_));
                    }
                    else
                    {
                        simplebakedmodel$builder.addFaceQuad(p_177578_2_.rotate(blockpartface.cullFace), this.makeBakedQuad(blockpart, blockpartface, textureatlassprite1, enumfacing, p_177578_2_, p_177578_3_));
                    }
                }
            }
    ...
    {
        return this.field_177607_l.makeBakedQuad(p_177589_1_.positionFrom, p_177589_1_.positionTo, p_177589_2_, p_177589_3_, p_177589_4_, p_177589_5_, p_177589_1_.partRotation, p_177589_6_, p_177589_1_.shade);
    }
    ...
    private void func_177572_j()
    {
        ...
        this.textureMap.func_174943_a(this.resourceManager, itexturemappopulator);
    ...
    protected ModelBlock func_177582_d(ModelBlock p_177582_1_)
    {
        return this.field_177608_m.func_178392_a(this.textureMap, p_177582_1_);
    }
