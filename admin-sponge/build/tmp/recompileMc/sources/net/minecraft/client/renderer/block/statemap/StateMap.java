...
public class StateMap extends StateMapperBase
{
    ...
    protected ModelResourceLocation func_178132_a(IBlockState p_178132_1_)
    {
        ...
        {
            s = ((ResourceLocation)Block.REGISTRY.getKey(p_178132_1_.getBlock())).toString();
        }
        else
        {
            s = String.format("%s:%s", Block.REGISTRY.getKey(p_178132_1_.getBlock()).getNamespace(), this.func_187490_a(this.field_178142_a, map));
        }
