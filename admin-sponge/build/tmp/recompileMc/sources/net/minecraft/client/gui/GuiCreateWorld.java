...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttons.clear();
        this.buttons.add(new GuiButton(0, this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("selectWorld.create")));
    ...
    protected void func_73869_a(char p_73869_1_, int p_73869_2_) throws IOException
    {
        ...
        (this.buttons.get(0)).enabled = !this.worldNameField.getText().isEmpty();
        this.calcSaveDirName();
    }
