...
public class GuiIngame extends Gui
{
    ...
    protected void func_184045_a(float p_184045_1_, ScaledResolution p_184045_2_)
    {
        ...
        if (gamesettings.thirdPersonView == 0)
        {
            ...
            {
                GlStateManager.pushMatrix();
                GlStateManager.translatef((float)(l / 2), (float)(i1 / 2), this.zLevel);
                Entity entity = this.mc.getRenderViewEntity();
                GlStateManager.rotatef(entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * p_184045_1_, -1.0F, 0.0F, 0.0F);
                GlStateManager.rotatef(entity.prevRotationYaw + (entity.rotationYaw - entity.prevRotationYaw) * p_184045_1_, 0.0F, 1.0F, 0.0F);
    ...
    protected void func_180479_a(ScaledResolution p_180479_1_, float p_180479_2_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            int k = 91;
            this.zLevel = -90.0F;
            this.drawTexturedModalRect(i - 91, p_180479_1_.func_78328_b() - 22, 0, 0, 182, 22);
            this.drawTexturedModalRect(i - 91 - 1 + entityplayer.inventory.currentItem * 20, p_180479_1_.func_78328_b() - 22 - 1, 0, 22, 24, 22);

            if (!itemstack.isEmpty())
            {
                if (enumhandside == EnumHandSide.LEFT)
                {
                    this.drawTexturedModalRect(i - 91 - 29, p_180479_1_.func_78328_b() - 23, 24, 22, 29, 24);
                }
                else
                {
                    this.drawTexturedModalRect(i + 91, p_180479_1_.func_78328_b() - 23, 53, 22, 29, 24);
                }
            }
    ...
    protected void func_184047_e(ScaledResolution p_184047_1_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            EntityPlayer entityplayer = (EntityPlayer)this.mc.getRenderViewEntity();
    ...
    protected void func_180476_e(ScaledResolution p_180476_1_)
    {
        ...
        bufferbuilder.pos(0.0D, (double)p_180476_1_.func_78328_b(), -90.0D).tex(0.0D, 1.0D).endVertex();
        bufferbuilder.pos((double)p_180476_1_.func_78326_a(), (double)p_180476_1_.func_78328_b(), -90.0D).tex(1.0D, 1.0D).endVertex();
        bufferbuilder.pos((double)p_180476_1_.func_78326_a(), 0.0D, -90.0D).tex(1.0D, 0.0D).endVertex();
    ...
    protected void func_180480_a(float p_180480_1_, ScaledResolution p_180480_2_)
    {
        ...
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferbuilder.pos(0.0D, (double)p_180480_2_.func_78328_b(), -90.0D).tex(0.0D, 1.0D).endVertex();
        bufferbuilder.pos((double)p_180480_2_.func_78326_a(), (double)p_180480_2_.func_78328_b(), -90.0D).tex(1.0D, 1.0D).endVertex();
        bufferbuilder.pos((double)p_180480_2_.func_78326_a(), 0.0D, -90.0D).tex(1.0D, 0.0D).endVertex();
        bufferbuilder.pos(0.0D, 0.0D, -90.0D).tex(0.0D, 0.0D).endVertex();
        tessellator.draw();
        GlStateManager.depthMask(true);
        GlStateManager.enableDepthTest();
    ...
    protected void func_180474_b(float p_180474_1_, ScaledResolution p_180474_2_)
    {
        ...
        GlStateManager.depthMask(false);
        GlStateManager.blendFuncSeparate(GlStateManager.SourceFactor.SRC_ALPHA, GlStateManager.DestFactor.ONE_MINUS_SRC_ALPHA, GlStateManager.SourceFactor.ONE, GlStateManager.DestFactor.ZERO);
        GlStateManager.color4f(1.0F, 1.0F, 1.0F, p_180474_1_);
        ...
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferbuilder.pos(0.0D, (double)p_180474_2_.func_78328_b(), -90.0D).tex((double)f, (double)f3).endVertex();
        bufferbuilder.pos((double)p_180474_2_.func_78326_a(), (double)p_180474_2_.func_78328_b(), -90.0D).tex((double)f2, (double)f3).endVertex();
        bufferbuilder.pos((double)p_180474_2_.func_78326_a(), 0.0D, -90.0D).tex((double)f2, (double)f1).endVertex();
