    ...
    public void handleResourcePack(SPacketResourcePackSend packetIn)
    {
        ...
        if (this.validateResourcePackUrl(s))
        {
            if (s.startsWith("level://"))
            {
                try
                {
                    ...
                    if (file2.isFile())
                    {
                        ...
                        Futures.addCallback(this.client.func_110438_M().func_177319_a(file2), this.createDownloadCallback());
                        return;
                    }
                }
            ...
            else
            {
                ...
                {
                    this.netManager.sendPacket(new CPacketResourcePackStatus(CPacketResourcePackStatus.Action.ACCEPTED));
                    Futures.addCallback(this.client.func_110438_M().func_180601_a(s, s1), this.createDownloadCallback());
                }
                            ...
                            NetHandlerPlayClient.this.client.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
                            {
                                public void func_73878_a(boolean p_73878_1_, int p_73878_2_)
                                {
                                    ...
                                    if (p_73878_1_)
                                    {
                                        ...
                                        Futures.addCallback(NetHandlerPlayClient.this.client.func_110438_M().func_180601_a(s, s1), NetHandlerPlayClient.this.createDownloadCallback());
                                    }
                                    else
                                    {
                                        if (serverdata1 != null)
