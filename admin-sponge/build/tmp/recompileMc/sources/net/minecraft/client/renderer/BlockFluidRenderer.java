...
public class BlockFluidRenderer
{
    ...
    public boolean func_178270_a(IBlockAccess p_178270_1_, IBlockState p_178270_2_, BlockPos p_178270_3_, BufferBuilder p_178270_4_)
    {
        ...
        int i = this.field_187500_a.getColor(p_178270_2_, p_178270_1_, p_178270_3_, 0);
        ...
        else
        {
            ...
            if (flag1)
            {
                ...
                float f25 = 1.0F * f1;
                float f26 = 1.0F * f2;
                p_178270_4_.pos(d0 + 0.0D, d1 + (double)f7, d2 + 0.0D).color(f24, f25, f26, 1.0F).tex((double)f13, (double)f17).lightmap(l2, i3).endVertex();
                p_178270_4_.pos(d0 + 0.0D, d1 + (double)f8, d2 + 1.0D).color(f24, f25, f26, 1.0F).tex((double)f14, (double)f18).lightmap(l2, i3).endVertex();
                p_178270_4_.pos(d0 + 1.0D, d1 + (double)f9, d2 + 1.0D).color(f24, f25, f26, 1.0F).tex((double)f15, (double)f19).lightmap(l2, i3).endVertex();
                p_178270_4_.pos(d0 + 1.0D, d1 + (double)f10, d2 + 0.0D).color(f24, f25, f26, 1.0F).tex((double)f16, (double)f20).lightmap(l2, i3).endVertex();
            ...
            if (flag2)
            {
                ...
                int i2 = l1 >> 16 & 65535;
                int j2 = l1 & 65535;
                p_178270_4_.pos(d0, d1, d2 + 1.0D).color(0.5F, 0.5F, 0.5F, 1.0F).tex((double)f35, (double)f38).lightmap(i2, j2).endVertex();
                p_178270_4_.pos(d0, d1, d2).color(0.5F, 0.5F, 0.5F, 1.0F).tex((double)f35, (double)f37).lightmap(i2, j2).endVertex();
                p_178270_4_.pos(d0 + 1.0D, d1, d2).color(0.5F, 0.5F, 0.5F, 1.0F).tex((double)f36, (double)f37).lightmap(i2, j2).endVertex();
                p_178270_4_.pos(d0 + 1.0D, d1, d2 + 1.0D).color(0.5F, 0.5F, 0.5F, 1.0F).tex((double)f36, (double)f38).lightmap(i2, j2).endVertex();
                flag3 = true;
            }
            ...
            for (int i1 = 0; i1 < 4; ++i1)
            {
                ...
                if (!flag)
                {
                    ...
                    if (state.getBlockFaceShape(p_178270_1_, blockpos, EnumFacing.BY_INDEX[i1+2].getOpposite()) == net.minecraft.block.state.BlockFaceShape.SOLID)
                    {
                ...
                if (aboolean[i1])
                {
                    ...
                    p_178270_4_.pos(d3, d1 + (double)f39, d4).color(f32, f33, f34, 1.0F).tex((double)f41, (double)f28).lightmap(k, l).endVertex();
                    p_178270_4_.pos(d5, d1 + (double)f40, d6).color(f32, f33, f34, 1.0F).tex((double)f27, (double)f29).lightmap(k, l).endVertex();
                    p_178270_4_.pos(d5, d1 + 0.0D, d6).color(f32, f33, f34, 1.0F).tex((double)f27, (double)f30).lightmap(k, l).endVertex();
                    p_178270_4_.pos(d3, d1 + 0.0D, d4).color(f32, f33, f34, 1.0F).tex((double)f41, (double)f30).lightmap(k, l).endVertex();
