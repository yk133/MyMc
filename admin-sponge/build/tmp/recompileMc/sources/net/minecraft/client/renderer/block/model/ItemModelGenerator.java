...
public class ItemModelGenerator
{
    ...
    public ModelBlock func_178392_a(TextureMap p_178392_1_, ModelBlock p_178392_2_)
    {
        ...
        for (int i = 0; i < LAYERS.size(); ++i)
        {
            ...
            String s1 = p_178392_2_.resolveTextureName(s);
            map.put(s, s1);
            TextureAtlasSprite textureatlassprite = p_178392_1_.getAtlasSprite((new ResourceLocation(s1)).toString());
        ...
        {
            map.put("particle", p_178392_2_.isTexturePresent("particle") ? p_178392_2_.resolveTextureName("particle") : (String)map.get("layer0"));
