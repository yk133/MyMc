...
public class Stitcher
{
    ...
    public void doStitch()
    {
        ...
        {
            bar.step(stitcher$holder.getAtlasSprite().func_94215_i());
            if (!this.allocateSlot(stitcher$holder))
            {
                String s = String.format("Unable to fit: %s - size: %dx%d - Maybe try a lowerresolution resourcepack?", stitcher$holder.getAtlasSprite().func_94215_i(), stitcher$holder.getAtlasSprite().getWidth(), stitcher$holder.getAtlasSprite().getHeight());
    ...
    public static class Holder implements Comparable<Stitcher.Holder>
        {
            ...
            {
                return "Holder{width=" + this.width + ", height=" + this.height + ", name=" + this.sprite.func_94215_i() + '}';
            }
            ...
            public int compareTo(Stitcher.Holder p_compareTo_1_)
            {
                ...
                if (this.getHeight() == p_compareTo_1_.getHeight())
                {
                    ...
                    {
                        if (this.sprite.func_94215_i() == null)
                        {
                            return p_compareTo_1_.sprite.func_94215_i() == null ? 0 : -1;
                        }

                        return this.sprite.func_94215_i().compareTo(p_compareTo_1_.sprite.func_94215_i());
                    }
