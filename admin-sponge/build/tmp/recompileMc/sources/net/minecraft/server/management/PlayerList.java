...
public abstract class PlayerList
{
    ...
    public void initializeConnectionToPlayer(NetworkManager netManager, EntityPlayerMP playerIn, NetHandlerPlayServer nethandlerplayserver)
    {
        ...
        if (playerWorld == null)
        {
            ...
            BlockPos spawnPoint = playerWorld.dimension.getRandomizedSpawnPoint();
        ...
        nethandlerplayserver.sendPacket(new SPacketJoinGame(playerIn.getEntityId(), playerIn.interactionManager.getGameType(), worldinfo.isHardcore(), worldserver.dimension.getDimension(), worldserver.getDifficulty(), this.getMaxPlayers(), worldinfo.getTerrainType(), worldserver.getGameRules().getBoolean("reducedDebugInfo")));
    ...
    public NBTTagCompound getPlayerNBT(EntityPlayerMP player)
    {
        ...
        NBTTagCompound nbttagcompound = this.server.worlds[0].getWorldInfo().getPlayerNBTTagCompound();
        if (player.func_70005_c_().equals(this.server.getServerOwner()) && nbttagcompound != null)
        {
    ...
    public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP playerIn, int dimension, boolean conqueredEnd)
    {
        ...
        else if (!world.dimension.canRespawnHere())
        {
            dimension = world.dimension.getRespawnDimension(playerIn);
        }
    ...
    {
        double moveFactor = oldWorldIn.dimension.getMovementFactor() / toWorldIn.dimension.getMovementFactor();
