...
public class DedicatedServer extends MinecraftServer implements IServer
{
    ...
    public boolean init() throws IOException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                Items.AIR.fillItemGroup(CreativeTabs.SEARCH, NonNullList.create());
    ...
    {
        this.pendingCommandList.add(new PendingCommand(p_71331_1_, p_71331_2_));
    }
    ...
    public void executePendingCommands()
    {
        while (!this.pendingCommandList.isEmpty())
        {
            ...
            this.func_71187_D().func_71556_a(pendingcommand.sender, pendingcommand.command);
        }
    }
    ...
    {
        if (worldIn.dimension.getDimension() != 0)
        {
            return false;
        }
    ...
    public String handleRConCommand(String command)
    {
        ...
        this.field_71321_q.func_71556_a(this.rconConsoleSource, command);
