...
public abstract class MinecraftServer implements ICommandSender, Runnable, IThreadListener, ISnooperInfo
{
    ...
    public void stopServer()
    {
        ...
        if (this.worlds != null)
        {
            ...
            {
                net.minecraftforge.common.DimensionManager.setWorld(world.dimension.getDimension(), null, this);
            }
        }
        ...
        for (int x = 0; x < ids.length; x++)
        {
            ...
            if (id == 0 || this.getAllowNether())
            {
                ...
                if (this.tickCounter % 20 == 0)
                {
                    ...
                    this.playerList.sendPacketToAllPlayersInDimension(new SPacketTimeUpdate(worldserver.getGameTime(), worldserver.getDayTime(), worldserver.getGameRules().getBoolean("doDaylightCycle")), worldserver.dimension.getDimension());
                    this.profiler.endSection();
                }
        ...
        if (this.worlds != null)
        {
            for (WorldServer worldserver1 : this.worlds)
            {
                if (worldserver1 != null)
                {
                    ...
                    playerSnooper.addClientStat("world[" + l + "][dimension]", Integer.valueOf(worldserver1.dimension.getType().getId()));
                    ...
                    playerSnooper.addClientStat("world[" + l + "][hardcore]", Boolean.valueOf(worldinfo.isHardcore()));
                    playerSnooper.addClientStat("world[" + l + "][generator_name]", worldinfo.getTerrainType().func_77127_a());
    ...
    public Entity func_175576_a(UUID p_175576_1_)
    {
        for (WorldServer worldserver1 : this.worlds)
        {
            if (worldserver1 != null)
            {
                Entity entity = worldserver1.getEntityFromUuid(p_175576_1_);
