...
public class PlayerInteractionManager
{
    ...
    public boolean tryHarvestBlock(BlockPos pos)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                this.world.playEvent(this.player, 2001, pos, Block.func_176210_f(iblockstate));
                boolean flag1 = false;
    ...
    public EnumActionResult processRightClickBlock(EntityPlayer player, World worldIn, ItemStack stack, EnumHand hand, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        if (this.gameType == GameType.SPECTATOR)
        {
            ...
            if (tileentity instanceof ILockableContainer)
            {
                ...
                {
                    ilockablecontainer = ((BlockChest)block1).func_180676_d(worldIn, pos);
                }
        ...
        else
        {
            ...
            else
            {
                ...
                if (this.isCreative())
                {
                    ...
                    EnumActionResult enumactionresult = stack.func_179546_a(player, worldIn, pos, hand, facing, hitX, hitY, hitZ);
    ...
    {
        player.getAttribute(EntityPlayer.REACH_DISTANCE).setBaseValue(distance);
    }
}